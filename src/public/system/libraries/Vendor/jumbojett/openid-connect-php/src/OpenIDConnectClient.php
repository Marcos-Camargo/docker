...
class OpenIDConnectClient
{
    ...
    public function authenticate() {
        ...
        if (isset($_GET['error'])) {
            $desc = isset($_GET['error_description']) ? ' Description: ' . $_GET['error_description'] : '';
            throw new OpenIDConnectClientException('Error: ' . $_GET['error'] .$desc);
        }
        ...
        if ($this->allowImplicitFlow && isset($_GET['id_token'])) {
