...
class Slack
{
    ...
    public function __construct() {
        if ($this->config->load('slack')) {
            if ($this->config->item('endpoint')) {
                $this->endpoint = $this->config->item('endpoint');
            }

            if ($this->config->item('username')) {
                $this->username = $this->config->item('username');
            }

            if ($this->config->item('icon')) {
                $this->icon = $this->config->item('icon');
            }

            if ($this->config->item('channel')) {
                $this->channel = $this->config->item('channel');
            }
        }
    }
