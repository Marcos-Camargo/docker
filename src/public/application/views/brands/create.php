      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php echo base_url('brands/brands_marketplaces') ?>" method="post" id="createBrandForm">
				...
				<div class="modal-body">
					<div class="row">
						<div class="form-group col-md-2">
							...
							<select class="form-control" id="int_to" name="int_to" required>
								...
								<option value="<?php echo ($k['int_to'])?>"><?php echo ($k['name'])?></option>
								<?php endforeach ?>
							</select>
						...
						<div class="form-group col-md-4">
							...
							<input type="text" class="form-control" id="name" name="name" placeholder="<?=$this->lang->line('application_enter_brand_name')?>" autocomplete="off" value="<?php echo set_value('name', $brand['name']) ?>"  required>
						...
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" id="title" name="title" placeholder="<?=$this->lang->line('application_enter_brand_title')?>" autocomplete="off"  required>
					...
					<div class="row">
						...
						<div class="form-group col-md-10">
							...
							<input type="text" class="form-control" id="metaTagDescription" name="metaTagDescription" placeholder="<?=$this->lang->line('application_enter_meta_tag_description')?>" autocomplete="off" required>
					...
					<div class="row">
						...
						<div class="form-group col-md-1">
							...
							<input type="text" class="form-control" id="Score" name="Score" autocomplete="off">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" class="form-control" id="LomadeeCampaignCode" name="LomadeeCampaignCode" autocomplete="off">
						...
						<div class="form-group col-md-5">
							...
							<input type="text" class="form-control" id="AdWordsRemarketingCode" name="AdWordsRemarketingCode" autocomplete="off">
...
$(document).ready(function() {
  ...
  // initialize the datatable 
   manageTable = $('#manageTable').DataTable({
	...
	"sortable": true,
	"serverMethod": "post",
	'ajax': "<?php echo base_url(); ?>"+'brands/fetchBrandsLinkData/'+"<?php echo $brand['id'] ?>",
	'order': [], 
	"ajax": $.fn.dataTable.pipeline({
            url: base_url + 'brands/fetchBrandsLinkData/'+"<?php echo $brand['id'] ?>",
