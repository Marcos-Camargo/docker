                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control pull-right datepicker" id="dt_inicio" name="dt_inicio"  autocomplete="off">                                     
                                    </div>
                                    
                                    <div class="form-group col-md-4">
                                        <label for="datainicio"><?=$this->lang->line('application_shipping_table_dt_fim');?></label>
                                        <input type="text" class="form-control pull-right datepicker" id="dt_fim" name="dt_fim"  autocomplete="off">                                     
                                    </div>
