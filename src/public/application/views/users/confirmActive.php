            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?= $this->lang->line('messages_active_confirm_mensage_users'); ?></h3>
                    </div>
                    <form role="form" action="<?= (base_url('users/update')) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-footer">
                            <a type="submit" href="<?php echo base_url('users/activeConfirmed/') . $store_id ?>" class="btn btn-success"><?= $this->lang->line('application_activate'); ?> </a>
