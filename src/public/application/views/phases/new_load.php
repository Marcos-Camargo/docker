                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="alert alert-warning alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <?= $this->lang->line('messages_worning_csv') ?>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="kv-avatar form-group col-md-8">
                                            <form role="form" action="<?php echo base_url('Phases/only_verify') ?>" method="post" enctype="multipart/form-data" id="upload-file">
                                                <label for="phase_upload"><?= $this->lang->line('messages_upload_file'); ?> oi</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <a download="plase_simple_import.csv" href="<?= base_url('assets/files/plase_simple_import.csv') ?>" class="btn btn-primary col-md-12" style="white-space: normal;"><i class="fa fa-download"></i> <br> <?= $this->lang->line('application_sample_phase_file'); ?></a>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#mainPhasesNav").addClass('active menu-open');
        $("#importByCSVPhasesNav").addClass('active');
