            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?= $this->lang->line('application_update_suggestion'); ?></h3>
                    </div>
                    <form role="form" action="<?= base_url('suggestions/update/' . $suggestion['id']) ?>" method="post">
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="type" id="type" required data-sexo>
                                                    <?php foreach ($types as $type) : ?>
                                                        <!-- <option>Fazer uma Pergunta</option> -->
                                                        <option value="<?= $type['value'] ?>" <?= set_select('type', $suggestion['type'], $type['value'] == $suggestion['type']) ?>><?= $type['text'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="categorie" id="categorie" required>
                                                    <?php foreach ($categories as $category) : ?>
                                                        <!-- <option>Fazer uma Pergunta</option> -->
                                                        <option <?= isset($category['disabled']) ? 'disabled="disabled"' : '' ?> <?= $category['value'] == '' ? '' : "value=\"" . $category['value'] . "\"" ?> <?= set_select('categorie', $suggestion['categorie'], $category['value'] == $suggestion['categorie']) ?>><?= $category['text'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-xs-12 <?php echo (form_error('title')) ? 'has-error' : '';  ?>">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="<?= $this->lang->line('application_title') ?>" required value="<?php echo set_value('title', $suggestion['title']) ?>" />
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-xs-12 <?php echo (form_error('description')) ? 'has-error' : '';  ?>">
                                            ...
                                            <textarea type="text" class="form-control" id="description" maxlength="1000" name="description" placeholder="<?= $this->lang->line('application_enter_description'); ?>" required><?= $suggestion['description'] ?></textarea>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-xs-12 <?php echo (form_error('tags')) ? 'has-error' : '';  ?>">
                                            ...
                                            <input type="text" class="form-control" id="tags" name="tags" placeholder="<?= $this->lang->line('application_tags_label') ?>" required value="<?php echo set_value('tags', $suggestion['tags']) ?>" />
...
<script type="text/javascript">
    $(document).ready(function() {
        if (<?= $suggestion['user_id'] != $user_id ? 'true' : 'false' ?>) {
