...
<div class="content-wrapper">
  <?php $data['pageinfo'] = ""; $data['page_now'] ='payment_release_fiscal_consulta'; $this->load->view('templates/content_header',$data); ?>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createPaymentReleaseFiscal', $user_permission)): ?>
...
$(document).ready(function() {
    ...
    $("#btn_novo_billet").click( function(){
    	window.location.assign(base_url.concat("billet/createconciliasellercenterfiscal"));
    });
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'billet/fetchConciliacaoGridDataFiscal/sellercenter',
    'order': []
  });
...
function exportaArquivoConciliacao(id){
	if(id){
		  var saida = 'billet/excelnfconciliacaorepassefiscal/' + id;
...
function confirmarLiberacaoPagamento(lote)
{
    Swal.fire({
        ...
        if (result.value) {
            window.location.href = '<?= base_url('billet/payconciliationsellercenterfiscal/') ?>' + lote;
        }
    })
}
