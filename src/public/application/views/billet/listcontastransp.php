        ...
        <div class="box">
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              <thead>
              <tr>
              	<th colspan="32" class="text-center">Mês: Junho/2020</th>
              </tr>
              <tr>
              	<th>Marketplace / Transportadora</th>
                <th> Dia1 </th>
                <th> Dia2 </th>
                <th> Dia3 </th>
                <th> Dia4 </th>
...
$(document).ready(function() {
    ...
    $("#btn_filtrar_transp").click( function(){
    	...
    	var novoCaminho = base_url + 'billet/fetchContaGridDataTransp/'+$("#slc_transportadora").val()+"/"+$("#slc_ciclo_transp").val();
  ...
  manageTable = $('#manageTable').DataTable({
	 'scrollX': true,
	 'colReorder': true,
    'ajax': base_url + 'billet/fetchContaGridDataTransp',
    'order': []
  });
