		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				...
				<div class="box">
					...
					<form role="form" action="<?php base_url('BlacklistWords/'.(is_null($wordData['id'])) ? 'create' : 'update'); ?>" method="post">
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="form-group col-md-12 d-flex">
									...
									<input type="text" class="form-control col-md-8" id="word" name="word" value="<?php echo set_value('words', $wordData['words']);?>" placeholder="<?= $this->lang->line('application_forbidden_word_here') ?>" autocomplete="off">
								</div>
								<div class="form-group col-md-12 d-flex">
                        ...
                        <div class="box-footer">
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-between">
                                    <a href="<?php echo base_url('BlacklistWords/') ?>" class="btn btn-warning col-md-3"><?= $this->lang->line('application_back') ?></a>
