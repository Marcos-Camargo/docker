      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div>
          <?php if(in_array('createCuration', $this->permission)) { ?>
          	 <a href="<?php echo base_url('blacklistWords/createnew') ?>" class="btn btn-primary"><?=$this->lang->line('application_button_add_word');?></a>
          <?php } ?>
        </div>
        <br />
        <div class="row">
          ...
          <div class="box-body"> 
            <table id="manageTable" aria-label="" class="table table-striped table-hover display table-condensed" style="border-collapse: collapse; width: 99%; border-spacing: 0;">
              ...
              <tr>
                ...
                <th><?= $this->lang->line('application_word') ?></th>
                <th>Responsável</th>
                <th>Início</th>
                <th>Fim</th>
  ...
  function getWords(){
    ...
    manageTable = $('#manageTable').DataTable({
      ...
      "ajax": $.fn.dataTable.pipeline({
        url: base_url + 'blacklistWords/fetchBlacklistData',
