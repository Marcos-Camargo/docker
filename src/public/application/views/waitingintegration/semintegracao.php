      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <form role="form" action="<?php echo base_url('waitingIntegration/mktselect') ?>" method="post" id="selectForm">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>             	
                ...
                <th width="10%" ><?=$this->lang->line('application_product_create');?></th>
...
$(document).ready(function() {
    ...
    $("#doIntegrationNav").addClass('active');
  ...
  //});
    ...
    table = $('#manageTable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: base_url + 'waitingIntegration/semintegracaodata',
            data: { marketplace: $('#selectMarketplace').val() },
