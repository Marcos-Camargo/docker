...
let manageTableProducts, manageTableSyncPublishedSku, manageTableGroupSimpleSku;
...
$('#products_btn, #sync_published_sku_btn, #group_simple_sku_btn').on('show.bs.tab', function(){
