<div class="modal fade" tabindex="-1" role="dialog" id="addVariationMap">
    <form>
...
<script>
    ...
    AddUpdateVariationMapModal = function (args) {
        args = args ?? {};
        this.title = args.popupTitle ?? '';
        this.component = $('#addVariationMap');
        this.deferred = $.Deferred();
        this.data = args.data ?? {};
    };
    AddUpdateVariationMapModal.prototype = {
