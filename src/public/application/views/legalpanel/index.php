  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createLegalPanel', $user_permission)): ?>
...
<?php if(in_array('deleteLegalPanel', $user_permission)): ?>
<!-- remove brand modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=$this->lang->line('application_legal_panel');?><span id="deletelegalpanel"></span></h4>
      </div>

      <form role="form" action="<?php echo base_url('legalpanel/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
    ...
    $("#btn_novo_billet").click( function(){
        window.location.assign(base_url.concat("legalpanel/create"));
    });

    // initialize the datatable
    manageTable = $('#manageTable').DataTable({
        "scrollX": true,
        'ajax': base_url + 'legalpanel/fetchLegalPanelData?'+filtros,
        'order': []
    });
