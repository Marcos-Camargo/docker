    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('marketplaces_integrations', $user_permission) && (!empty($tocreate))): ?>
            <a href="<?php echo base_url('vertemStoreConfig/create') ?>" class="btn btn-primary"><?=$this->lang->line('application_create_integration');?></a>
            <br /> <br />
          <?php endif; ?>
		  ...
		  <div class="">
	          ...
	          <div class="col-md-2">
	            <label for="buscasellerid" class="normal"><?=$this->lang->line('application_supplier_id');?></label>
	            <div class="input-group">
	              <input type="search" id="buscasellerid" onchange="buscaStore()" class="form-control" placeholder="<?=$this->lang->line('application_supplier_id');?>" aria-label="Search" aria-describedby="basic-addon1">
	              <span class="input-group-addon" id=""><i class="fas fa-search text-grey" aria-hidden="true"></i></span>
	            </div>
	          </div>
            ...
            <div class="box-body">
              <table id="manageTable" class="table table-bordered table-striped" cellspacing="0" style="border-collapse: collapse; width: 100%;">
                ...
                <tr>
                  ...
                  <th><?=$this->lang->line('application_supplier_id');?></th>
...
function buscaStore(){
  ...
  let sellerid = $('#buscasellerid').val();
  ...
  manageTable = $('#manageTable').DataTable({
    ...
    "ajax": $.fn.dataTable.pipeline({
      url: base_url + 'vertemStoreConfig/fetchIntegrationData',
      data: { [csrfName]: csrfHash, loja: loja, empresa: empresa, sellerid: sellerid, status: status},
      pages: 2
    })
  });
}
