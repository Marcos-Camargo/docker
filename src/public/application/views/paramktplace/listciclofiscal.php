...
<div class="content-wrapper">
  ...
  <?php $data['page_now'] = "parameter_mktplace_ciclos_fiscal";
        $data['pageinfo'] = "application_discountworksheet_list"; 
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createParamktplaceFiscal', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal" id="btnAddCicloFiscalModal"><?=$this->lang->line('application_add_ciclos');?></button>
          ...
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><?=$this->lang->line('application_payment_fiscal_close_date');?></th>
                <th><?=$this->lang->line('application_paramktplace_cut_date');?></th>
                <?php if(in_array('updateParamktplaceFiscal', $user_permission) || in_array('deleteParamktplaceFiscal', $user_permission)): ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=$this->lang->line('application_parameter_mktplace_ciclos_fiscal');?> - <?=$this->lang->line('application_add');?></h4>
      </div>
      ...
      <form role="form" action="" method="post" id="createForm" name="createForm">
        ...
        <div class="modal-body">
            ...
            <label for="cmb_mktplace"><?=$this->lang->line('application_marketplace');?></label>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="cmb_data_corte" name="cmb_data_corte">
              <option value="Data Pago">Data Pago</option>
          ...
          <div class="form-group">
            <label for="txt_valor_aplicado"><?=$this->lang->line('application_payment_fiscal_close_date');?></label>
            <input type="number" class="form-control" id="txt_data_pagamento" name="txt_data_pagamento" placeholder="<?=$this->lang->line('application_payment_fiscal_close_date')?>" min="1" max="31" step='1'>
          </div>
...
<?php if(in_array('deleteParamktplaceFiscal', $user_permission)): ?>
<!-- remove brand modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?=$this->lang->line('application_remove_ciclos_fiscal')?></h4>
      </div>

      <form role="form" action="" method="post" id="removeForm">
        <div class="modal-body">
          <p>Deseja <?=$this->lang->line('application_remove_ciclos')?> Fiscal?</p>
        </div>
        <div class="modal-footer">
...
$(document).ready(function() {
  ...
  $("#cicloFiscalNav").addClass('active');
  $("#paraMktPlaceNav").addClass('active');

    $("#btnAddCicloFiscalModal").click(function(){
      $('#createForm').trigger("reset");
    });

    $("#btnSave").click(function() {

	  if($("#txt_valor_ciclo").val() == "" || $("#txt_data_inicio").val() == "" || $("#txt_data_fim").val() == "" || $("#txt_data_pagamento").val() == ""){
			alert("Valor de Ciclo inválido");
			return false;
	  }
	  
	  $("#btnSave").prop('disabled', true);
	  var pageURL = base_url.concat("paramktplace/verificacadastrocicloFiscal");
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'paramktplace/fetchParamktPlaceDataFiscal',
    'order': []
  });
...
function removeFuncCiclo(id)
{
  if(id) {
      $("#btnRemover").click(function (){
    	  var pageURL = base_url.concat("paramktplace/removeciclofiscal");
