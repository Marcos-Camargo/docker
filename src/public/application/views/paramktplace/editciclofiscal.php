        ...
        <div class="box">
          <form role="form" action="" method="post" id="createForm" name="createForm">
    		...
    		<div class="form-group">
                <label for="volume_type"><?=$this->lang->line('application_marketplace');?></label>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="txt_data_pagamento" name="txt_data_pagamento" placeholder="<?=$this->lang->line('application_payment_fiscal_close_date')?>" value='<?php echo $paramktplace_data['data_ciclo_fiscal']; ?>' min="1" max="31" step='1'>
              </div>
    ...
    $("#cmb_data_corte").val(cmb_data_corte);
	  $("#btnEdit").click(function() {
		 ...
		 $("#btnEdit").prop('disabled', true);
		  var pageURL = base_url.concat("paramktplace/verificaedicaociclofiscal");
		  $.post( pageURL, serialized, function( data ) {
			  ...
			  if(saida[0] == "1"){
				...
				$("#btnEdit").prop('disabled', false);
				  ...
				  window.location.href = base_url+"paramktplace/listciclofiscalsellercenter";
			  } 
		  });
	  });
      ...
      $("#btnVoltar").click( function(){
      	window.location.assign(base_url.concat("paramktplace/listciclofiscalsellercenter"));
      });
  });
</script>