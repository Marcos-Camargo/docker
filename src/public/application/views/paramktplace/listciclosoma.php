  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=$this->lang->line('application_add_ciclos');?></h4>
      </div>
...
$(document).ready(function() {
    ...
    $("#btnSave").click(function() {
	  ...
	  var pageURL = base_url.concat("paramktplace/verificacadastrociclosoma");
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'paramktplace/fetchParamktPlaceDataCiclosoma',
    'order': []
  });
...
function removeFuncCiclo(id)
{
  if(id) {
      $("#btnRemover").click(function (){
    	  var pageURL = base_url.concat("paramktplace/removeciclosoma");
