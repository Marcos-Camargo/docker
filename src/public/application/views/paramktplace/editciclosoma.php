          ...
          <form role="form" action="" method="post" id="createForm" name="createForm">
    		...
    		<div class="form-group">
              ...
              <!-- <div class="form-group">
                ...
                <input type="number" class="form-control" id="txt_data_pagamento_conecta" name="txt_data_pagamento_conecta" placeholder="<?=$this->lang->line('application_payment_date_conecta')?>" value='0' min="1" max="31" step='1'>
              </div>  -->
    ...
    $("#cmb_data_corte").val(cmb_data_corte);
	  $("#btnEdit").click(function() {
		 ...
		 $("#btnEdit").prop('disabled', true);
		  var pageURL = base_url.concat("paramktplace/verificaedicaociclosoma");
		  $.post( pageURL, serialized, function( data ) {
			  ...
			  if(saida[0] == "1"){
				...
				$("#btnEdit").prop('disabled', false);
				  ...
				  window.location.href = base_url+"paramktplace/listciclosellercenter";
			  } 
		  });
	  });
      ...
      $("#btnVoltar").click( function(){
      	window.location.assign(base_url.concat("paramktplace/listciclosellercenter"));
      });
  });
</script>