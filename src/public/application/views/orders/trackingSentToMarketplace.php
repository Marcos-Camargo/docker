    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
		  <form role="form" action="<?php echo base_url('orders/trackingMktSelect') ?>" method="post" id="selectForm">
            ...
            <div class="col-md-12">
	          ...
	          <div class="col-md-3">  
				  <button type="submit" class="btn btn-primary" id="select" name="select"><?=$this->lang->line('application_mark_as_tracking');?></button>
	          </div>	
	          <!----
	          <div class="col-md-3">  
...
$(document).ready(function() {
    ...
    $("#trackingMktNav").addClass('active');
    ...
    var table = $('#manageTable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: base_url + 'orders/trackingMktData',
            data: { }, 
