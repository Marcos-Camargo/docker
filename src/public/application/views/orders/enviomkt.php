...
Lista Pedidso que precisam ser marcados como enviados para o marketplace
...
<div class="content-wrapper">
	...
	<?php $data['pageinfo'] = "application_manage";  
	 $data['page_now'] ='sendto_marketplace';
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
		  <form role="form" action="<?php echo base_url('orders/envioMktSelect') ?>" method="post" id="selectForm">
            ...
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>             	
                ...
                <th><?=$this->lang->line('application_ship_date');?></th>  
            ...
            <div class="col-md-12">
	          ...
	          <div class="col-md-3">  
				  <button type="submit" class="btn btn-primary" id="select" name="select"><?=$this->lang->line('application_mark_as_sendto');?></button>
	          </div>	
	          <!----
	          <div class="col-md-3">  
  ...
  //});
    ...
    var table = $('#manageTable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: base_url + 'orders/envioMktData',
            data: { }, 
