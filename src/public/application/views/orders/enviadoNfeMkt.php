    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
		  <form role="form" action="<?php echo base_url('orders/invoiceMktSelect') ?>" method="post" id="selectForm">
            ...
            <div class="col-md-12">
	          ...
	          <div class="col-md-3">  
				  <button type="submit" class="btn btn-primary" id="select" name="select"><?=$this->lang->line('application_mark_as_invoice');?></button>
	          </div>	
	          <!----
	          <div class="col-md-3">  
  ...
  //});
    ...
    var table = $('#manageTable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: base_url + 'orders/invoiceMktData',
            data: { }, 
