          ...
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><?=$this->lang->line('application_status');?> - Saque</th>
                <th>Data Saque</th>
...
$(document).ready(function() {
  ...
  $("#slc_store").select2();
	...
	$("#btnBuscar").click( function(){
    	...
    	var novoCaminho = base_url + 'iugu/getrelatoriosaque/'+$("#slc_store").val();
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'iugu/getrelatoriosaque/'+$("#slc_store").val(),
    'order': []
  });

  $("#btnExcel").click( function(){

    var saida = 'iugu/getrelatoriosaqueexcel/' + $("#slc_store").val();
