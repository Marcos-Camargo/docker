                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="kv-avatar form-group col-md-8">
                                            <form role="form" action="<?php echo base_url('payment/uploadarquivonfurl') ?>" method="post" enctype="multipart/form-data" id="upload-file">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <a download="arquivo_modelo_notafiscal_url.xlsx" href="<?= base_url('assets/files/arquivo_modelo_notafiscal_url.xlsx') ?>" class="btn btn-primary col-md-12" style="white-space: normal;"><i class="fa fa-download"></i> <br> Baixar Exemplo de carga de Nota Fiscal</a>
                                        </div>
                                    </div>
                                </div>
