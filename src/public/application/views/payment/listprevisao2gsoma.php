          ...
          <div class="box-body">
            <table id="manageTable2" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <?php }else{ ?>
                  <th class="data-corte-de">Data de envio de:</th>
                  <th class="data-corte-ate">Data de envio até:</th>
                  <th>Data Pagamento</th>
                <?php } ?>
              </tr>
              </thead>
...
$(document).ready(function() {
  ...
  $("#previsaosellercenterNav").addClass('active');

  // initialize the datatable 
  manageTable1 = $('#manageTable1').DataTable({
    'ajax': base_url + 'payment/extratoprevisao2gsoma',
    "pageLength": 100,
	"lengthChange": false,
	"bFilter": false,
	"paging": false,
    ...
    manageTable2 = $('#manageTable2').DataTable({
        'ajax': base_url + 'payment/extratoprevisaodataspagamentogsoma',
        "pageLength": 100,
        "lengthChange": false,
        "bFilter": false,
        "paging": false,
