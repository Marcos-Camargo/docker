	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				...
				<div class="box">
					<form action="<?php base_url('templateEmail/update') ?>" method="post" enctype="multipart/form-data" id="formInsertTemplateEmail">
						<div class="box-body">
							<?php
							...
							<div id="form_title" class="form-group col-md-12 col-xs-12">
								...
								<input type="text" class="form-control" id="template_email_title" maxlength="<?= $template_email_length_title ?>" name="template_email_title"  placeholder="<?= 'Digite o título do template de email' //$this->lang->line('application_enter_product_name'); ?>" value="<?php echo set_value('template_email_title', $template_email_data['title']) ?>" autocomplete="off" />
							...
							<div id="form_subject" class="form-group col-md-12 col-xs-12">
								...
								<input type="text" class="form-control" id="template_email_subject" maxlength="<?= $template_email_length_subject ?>" name="template_email_subject"  placeholder="<?= 'Digite o assunto do template de email' //$this->lang->line('application_enter_product_name'); ?>" value="<?php echo set_value('template_email_subject', $template_email_data['subject']) ?>" autocomplete="off" />
							...
							<div id="form_description" class="form-group col-md-12 col-xs-12 <?php echo (form_error('template_email_description')) ? 'has-error' : '';  ?>">
								...
								<textarea type="text" class="form-control" id="template_email_description" name="template_email_description" placeholder="<?= $this->lang->line('application_enter_description'); ?>"><?php echo set_value('template_email_description', $template_email_data['description']) ?></textarea>
