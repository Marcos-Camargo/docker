      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" id="formedit" action="<?php base_url('promotions/createone') ?>" method="post">
              <div class="box-body">
		...
		<?php	}
		        ...
		        <div class="form-group col-md-2 col-xs-2">
					...
					<div class='input-group time' >
						  ...
						  <option value="00:00" <?php echo set_select('start_time', "00:00"); ?>>00:00</option>
		        ...
		        <div class="form-group col-md-2 col-xs-2">
					...
					<div class='input-group time' >
						  ...
						  <option value="00:00" <?php echo set_select('end_time', "00:00"); ?>>00:00</option>
						  <option value="09:00" <?php echo set_select('end_time', "09:00"); ?>>09:00</option>
						  <option value="13:00" <?php echo set_select('end_time', "13:00"); ?>>13:00</option>
						  <option value="17:00" <?php echo set_select('end_time', "17:00"); ?>>17:00</option>
						</select>
		          		<span class="input-group-addon">
		                    <span class="fa fa-clock-o"></span>
		                </span>
				...
				<div class="form-group col-md-3 col-xs-3">
					 ...
					 <?php  } else { ?>
	       			 	<input id="typepromo" name="typepromo" type="checkbox" value="1" <?php echo set_checkbox('typepromo', '1'); ?>  data-toggle="toggle" data-on="<?=$this->lang->line('application_promotion_type_date');?>" data-off="<?=$this->lang->line('application_promotion_type_stock');?>" data-onstyle="success" data-offstyle="primary" >
					<?php  } ?>
					</div>
				</div>  
				...
				<div class="row">
					<div class="form-group col-md-2">
	                    ...
	                    <input type="text" readonly class = "form-control" id="stock" value="<?=$product['qty']?>" >
	                </div>
					<?php if ($product['qty'] >= 100) { ?>
	                <div id="porestoque" class="form-group col-md-2 col-xs-2" <?php echo (form_error('qty')) ? "has-error" : "";?> />
			  			<label for="qty"><?=$this->lang->line('application_promotion_qty');?>:</label>
		       		    <input type="text" class="form-control"  style="text-align:right;"  id="qty" name="qty" value="<?php echo set_value('qty'); ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
				...
				<div class="form-group col-md-2 col-xs-2">
		  			<label><?=$this->lang->line('application_price_from');?>:</label>
	       		    <span style="text-align:right;" class = "form-control"><?php echo get_instance()->formatprice($product['price'])?></span>
				</div>
				<div class="form-group col-md-2 col-xs-2" <?php echo (form_error('price')) ? "has-error" : "";?>>
                  ...
                  <input type="text" class="form-control maskdecimal2" style="text-align:right;" id="price" name="price"  value="<?php echo set_value('price'); ?>" autocomplete="off"  />
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary"><?=$this->lang->line('application_create_promotion');?></button>
                <a href="<?php echo base_url('products/update/'.$product['id']); ?>" class="btn btn-warning"><?=$this->lang->line('application_back');?></a>
              </div>
            </form>
          </div>
          <!-- /.box -->
