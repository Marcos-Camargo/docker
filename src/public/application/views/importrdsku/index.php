<div class="content-wrapper">
  <?php $data['pageinfo'] = "application_import"; 
    $data['page_now'] = 'import_rd_skus';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="kv-avatar form-group col-md-8">
                                            <form role="form" action="<?php echo base_url('importRDSku/upload_csv_file') ?>" method="post" enctype="multipart/form-data" id="upload-file">
