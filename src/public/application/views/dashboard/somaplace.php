      ...
      <!-- Small boxes (Stat box) -->
        ...
        <div class="row dashboard-boxs">
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-blue-light">
                    <div class="inner">
                        <h3><?=$total_products_with_changed_price?></h3>
                        <p><?=$this->lang->line('application_alert_price_catalog_updated')?></p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-bell" aria-hidden="true"></i>
                    </div>
                    <a href="#" onclick="openBoxFilter('products', 'products_filter_price_catalog');return false" class="small-box-footer bg-blue"><?=$this->lang->line('application_more_info');?> <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
