          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-blue-light">
              ...
              <div class="icon">
               ...
               <a href="<?php echo base_url('orders/freteEntregue') ?>" class="small-box-footer bg-blue"><?=$this->lang->line('application_more_info');?> <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
