...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php $user_permission = $user_permission ?? []; ?>
        <?php if($user_permission): ?>
          ...
          <?php endif; ?>
          <?php if(hasPermission(['deleteHierarchyComission', 'viewHierarchyComission', 'updateHierarchyComission', 'createHierarchyComission'], $user_permission)
            && $this->model_settings->getValueIfAtiveByName('allow_hierarchy_comission')): ?>
            <li id="hierarchyComissionNav">
              <a class="menuhref" href="<?php echo base_url('commissioning/') ?>">
                  <i class="fa fa-solid fa-cash-register"></i> <span><?=$this->lang->line('application_commissioning');?></span>
              </a>
            </li>
          <?php endif; ?>
            ...
            <li class="treeview" id="paraMktPlaceNav">
              ...
              <ul class="treeview-menu">
                ...
                <?php if(in_array('createPaymentForecast', $user_permission) || in_array('updatePaymentForecast', $user_permission) || in_array('viewPaymentForecast', $user_permission) || in_array('deletePaymentForecast', $user_permission)): ?>
                  <li id="previsaosellercenterNav"> <a class="menuhref" href="<?php echo base_url('payment/listprevisaosellercenter') ?>"> <i class="fa fa-cogs"></i> <span><?=$this->lang->line('application_parameter_payment_forecast');?></span> </a> </li>
                <?php endif; ?>
                  ...
                  <?php if(isset($novomundo_painel_financeiro) && $novomundo_painel_financeiro['status'] == "1"){ ?>
                ...
                <?php if (in_array('createPaymentRelease', $user_permission) || in_array('updatePaymentRelease', $user_permission) || in_array('viewPaymentRelease', $user_permission) || in_array('deletePaymentRelease', $user_permission)) : ?>
                    <li id="paymentReleaseNav"> <a class="menuhref" href="<?php echo base_url('billet/listsellercenter') ?>"> <i class="fa fa-cogs"></i> <span><?php if($novomundo_painel_financeiro['status'] == "1"){echo $this->lang->line('application_conciliacao_novomundo');}else{echo $this->lang->line('application_payment_release');}?></span> </a> </li>
                <?php endif; ?>

                <?php if (in_array('createPaymentReleaseFiscal', $user_permission) || in_array('updatePaymentReleaseFiscal', $user_permission) || in_array('viewPaymentReleaseFiscal', $user_permission) || in_array('deletePaymentReleaseFiscal', $user_permission)) : ?>
                    <li id="paymentReleaseFiscalNav"> <a class="menuhref" href="<?php echo base_url('billet/listsellercenterfiscal') ?>"> <i class="fa fa-cogs"></i> <span><?php echo $this->lang->line('application_payment_release_fiscal');?></span> </a> </li>
                <?php endif; ?>

                  <?php if (ENVIRONMENT === 'development2'): ?>
                ...
                <?php if(in_array('createLegalPanelFiscal', $user_permission) || in_array('updateLegalPanelFiscal', $user_permission) || in_array('viewLegalPanelFiscal', $user_permission) || in_array('deleteLegalPanelFiscal', $user_permission)): ?>
                    <li id="paineljuridicofiscalNav"> <a class="menuhref" href="<?php echo base_url('legalpanelfiscal/') ?>"> <i class="fa fa-cogs"></i> <span><?php echo $this->lang->line('application_legal_panel_fiscal'); ?></span> </a> </li> 
                <?php endif; ?>
                ...
                <?php
                    ...
                    if (in_array('balanceTransfers', $user_permission) && in_array($gateway_id, $gateways_with_payment_report)):
						$transfer_link  = ($allow_transfer_between_accounts === "1") ? 'application_balances_transfers_menu' :  'application_balances_transfers_not_allowed_menu';
                ?>
                  <li id="balanceTransfers"> <a class="menuhref" href="<?php echo base_url('payment/balanceTransfers') ?>"> <i class="fa fa-cogs"></i> <span><?=$this->lang->line($transfer_link);?></span> </a> </li>
                <?php endif; ?>
                  <?php
                ...
                <?php if(in_array('createParamktplaceFiscal', $user_permission) || in_array('updateParamktplaceFiscal', $user_permission) || in_array('viewParammktplaceFiscal', $user_permission) || in_array('deleteParamktplaceFiscal', $user_permission)): ?>
                  <li id="cicloFiscalNav"> <a class="menuhref" href="<?php echo base_url('paramktplace/listciclofiscalsellercenter') ?>"> <i class="fa fa-cogs"></i> <span><?=$this->lang->line('application_parameter_mktplace_ciclo_fiscal');?></span> </a> </li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php
            /*
            if(in_array('createPromotions', $user_permission) || in_array('updatePromotions', $user_permission) || in_array('viewPromotions', $user_permission) || in_array('deletePromotions', $user_permission)): ?>
            ...
            <?php if(in_array('createCampaigns', $user_permission) || in_array('updateCampaigns', $user_permission) || in_array('viewCampaigns', $user_permission) || in_array('deleteCampaigns', $user_permission) || in_array('viewCampaignsStore', $user_permission) || in_array('updateCampaignsStore', $user_permission)): ?>
                <li class="treeview" id="mainCampaignsNav">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
					<?php
//                            if(in_array('createCampaigns', $user_permission) && !$this->session->userdata('userstore') && $this->data['only_admin'] && $this->data['usercomp'] == 1):
					    if(in_array('createCampaigns', $user_permission) ):
                    ?>
            ...
            <li class="treeview" id="mainOrdersNav">
              ...
              <ul class="treeview-menu">
		        ...
		        <?php if (in_array('updateOrdersCancelCommissionCharges', $user_permission) ): ?>
                  <li id="ReturnOrderNavMassive"><a class="menuhref" href="<?php echo base_url('ProductsReturn/returnMassive') ?>"><i class="fa fa-circle-o"></i> <?=$this->lang->line('application_massive_order_refund');?></a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
      ...
      <?php endif; ?>
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <?php if(in_array('createProviders', $user_permission)): ?>
                            ...
                            <?php } else { ?>
                              <li id="addProvidersNav"><a class="menuhref" href="<?php echo base_url('providers/createsimplified') ?>"><i class="fa fa-circle-o"></i> <?=$this->lang->line('application_add_providers');?></a></li>
                            <?php } ?>                            
                        <?php endif; ?>
              ...
              <ul class="treeview-menu">			              
                ...
                <?php }
                 ...
                 <?php if ($use_agidesk == 1) {
                  ...
                  <?php if(in_array('viewOdooService', $user_permission) ): ?>
                      <li id="goToOdoo">
                          <a target="_blank" href="https://maiscorreios.sac.ifctech.com.br/my">
                              <i class="glyphicon glyphicon-share-alt"></i>
                              <span><?= $this->lang->line('answer_odoo_calls'); ?></span>
                          </a>
                      </li>
                  <?php endif; ?>
              </ul>
        ...
        <?php $service_rd = $this->model_settings->getSettingDatabyName('atendimento_rd');
        if($service_rd && $service_rd['status'] == 1) { ?>
            <li id="profileNavRD"><a class="menuhref" href="https://www.lojistard.com.br/SignIn" target="_blank"><i class="fa fa-user-o"></i> <span><?=$this->lang->line('application_profile_rd');?></span></a></li>
        <?php }?>
        ...
        <li class="treeview" id="mainIntegrationApiNav">
            ...
            <ul class="treeview-menu">
                ...
                <?php endif; ?>
                <?php if(
                  in_array('sendOrderToDelivered', $user_permission)):?>
                  <li id="sendOrderToDelivered"><a class="menuhref" href="<?php echo base_url('orderToDelivered') ?>"><i class="fa fa-circle-o"></i> <?=$this->lang->line('send_order_to_delivered');?></a></li>
                <?php endif; ?>
                <?php if(
...
<!--        </li>-->
        ...
        <?php if(in_array('updateMarketplace', $user_permission) || in_array('viewMarketplace', $user_permission) || in_array('deleteMarketplace', $user_permission)): ?>
            <li class="treeview" id="mainMarketPlaceNav">
              <a class="menuhref" href="#">
                <i class="fa fa-cloud-upload"></i>
                <span><?=$this->lang->line('application_job_schedule');?></span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <?php if(in_array('createCalendar', $user_permission) || in_array('updateCalendar', $user_permission) || in_array('viewCalendar', $user_permission) || in_array('deleteCalendar', $user_permission)): ?>
        ...
        <?php endif; ?>
        <?php endif; ?>
        <?php if(is_array($user_permission) && in_array('delete_suggestions', $user_permission)): ?>
        ...
        <?php endif; ?>
    <?php if (is_array($user_permission) && in_array('notification_center', $user_permission)) : ?>
    <li class="treeview" id="mainIntegrationMarketplaceNav">
        <a class="menuhref" href="#">
    ...
    <?php endif; ?>
        ...
        <?php $customizationTheme = $this->model_settings->getActivePersonalize();
        if($customizationTheme && $customizationTheme['status'] == 1) { ?>
         <li style="background-color:black;"><a class="menuhref" href="<?php echo base_url('CustomizationTheme') ?>" style="color:yellow;"><i class="fa fa-edit"></i> <span>Personalizar</span></a></li>
        <?php }?>
      </ul>
    </section>
    <!-- /.sidebar -->
