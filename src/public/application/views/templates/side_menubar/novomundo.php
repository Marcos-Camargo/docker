            ...
            <li class="treeview" id="paraMktPlaceNav">
              ...
              <?php }?>
                ...
                <?php if (in_array('createPaymentRelease', $user_permission) || in_array('updatePaymentRelease', $user_permission) || in_array('viewPaymentRelease', $user_permission) || in_array('deletePaymentRelease', $user_permission)) : ?>
                   <li id="paymentReleaseNav"> <a class="menuhref" href="<?php echo base_url('billet/listsellercenter') ?>"> <i class="fa fa-cogs"></i> <span><?=$this->lang->line('application_conciliacao_novomundo');?></span> </a> </li>
                <?php endif; ?>
...
<!--                        <span>--><?php //=$this->lang->line('application_campaigns');?><!--</span>-->
<!--                        <span class="pull-right-container">-->
<!--                  <i class="fa fa-angle-left pull-right"></i>-->
<!--                </span>-->
<!--                    </a>-->
...
<!--                            <li id="addCampaignsNav"><a href="--><?php //echo base_url('campaigns_v2/createcampaigns') ?><!--"><i class="fa fa-circle-o"></i> --><?php //=$this->lang->line('application_add_campaign_v2');?><!--</a></li>-->
<!--                        --><?php //endif; ?>
...
<!--                            <li id="manageCampaignsNav"><a class="menuhref" href="--><?php //echo base_url('campaigns_v2') ?><!--"><i class="fa fa-circle-o"></i> --><?php //=$this->lang->line('application_manage_campaigns_v2');?><!--</a></li>-->
<!--                        --><?php //endif; ?>
<!--                    </ul>-->
<!--                </li>-->
            <?php endif; ?>
        ...
        <?php if((in_array('viewManagementReport', $user_permission) || ($hasReportGroupsAdmin)) && count($menuMetabse_adm)): ?>    
          ...
          <li class="treeview" id="mainIntegrationNav">
            ...
            <ul class="treeview-menu">			              
              ...
              <?php if ($link_atendimento_externo) { 
