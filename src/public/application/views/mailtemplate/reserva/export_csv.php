<body lang=PT-BR link='#0563C1' vlink='#954F72' style='tab-interval:35.4pt'>
    ...
    <p style='text-align:center;'><img width=210 height=63 src='<?=$logo?>' ></p>
        ...
        <p style='text-align:left;'><span style='font-family:' Helvetica',sans-serif;color:#404040;background:white'>O nosso suporte está sempre pronto para te atender <a href="https://reserva.agidesk.com/servicos">através do link!</a></span></p><br>
	    ...
	    <span style='background:white'>Reserva</span></p>
        <br><br>
    </div>
</body>