            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <form role="form" id="frmCadastrar" name="frmCadastrar"
                          action="<?php base_url('legalpanelfiscal/create') ?>" method="post">
                        <div class="box-body">
                            <div class="row">
                                <?php
                            ...
                            <div class="col-md-2 col-xs-2 <?php echo (form_error('balance_debit')) ? 'has-error' : '';  ?>">
                                <label for="txt_saldo"><?= $this->lang->line('application_balance_credit'); ?> (*)</label>
                            ...
                            <?php if (isset($legal_panel['conciliacao_id'])): ?>
                                ...
                                <div class="col-md-3 col-xs-3  <?php echo (form_error('conciliacao_id')) ? 'has-error' : '';  ?> ">
                                    ...
                                    <a target="_blank" href="<?php echo base_url('billet/editsellercenterfiscal/'.$legal_panel['lote']) ?>"
    ...
    $(document).ready(function () {
        ...
        if (isset($legal_panel['id']) && $legal_panel['id']){
            ...
            manageTable = $('#tabelaPedidosAdd').DataTable({
                ...
                "serverMethod": "post",
                'ajax': {
                    url: base_url + 'billet/fetchlegalpanelfiscalsellercenterconciliacao/<?php echo $legal_panel['id'] ?: null; ?>',
                    'data': function(data){
                    }
                },
                "order": [[ 0, "desc" ]],
        ...
        $("#btnVoltar").click(function () {
            window.location.assign(base_url.concat("legalpanelfiscal/"));
        });
        ...
        var uploadUrl = base_url.concat("legalpanelfiscal/fileUpload");
        var deleteUrl = base_url.concat("legalpanelfiscal/deleteFile");
        ...
        $.ajax({
            ...
            url: base_url + "legalpanelfiscal/getFiles",
            dataType: "json",
            async: true,
