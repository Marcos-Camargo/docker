    ...
    <div class="row">
        <div class="col-md-3 col-xs-12">
            <div class="box box-alert alert alert-warning ">
                <div class="box-body">
                    <?= $this->lang->line('application_import_rules_product') ?>
        ...
        <div class="box box">
            <div class="box-body">
                <div class="col-md-3 col-xs-12">
                    <?= $this->lang->line('application_import_product_step_1') ?>
                    <hr>
                    <a download="sample_products.csv" href="<?=base_url('assets/files/sample_products.csv') ?>"><i class="fa fa-download"></i>  <?=$this->lang->line('application_sample_product_file2');?></a><br><br>
                    <a download="sample_products_stock.csv" href="<?=base_url('assets/files/sample_products_stock.csv') ?>"><i class="fa fa-download"></i> <?=$this->lang->line('application_sample_product_file_stock_price2');?> </a><br><br>
                    <a download="sample_product_inativation_trash.csv" href="<?=base_url('assets/files/sample_product_inativation_trash.csv') ?>"><i class="fa fa-download"></i> <?=$this->lang->line('application_product_inativation_sample_file');?></a>
                </div>
                <div class="col-md-3 col-xs-12">
                    ...
                    <?php if(in_array('createProduct', $user_permission)): ?>
                        ...
                        <a href="<?=base_url('export/origemxls') ?>"><i class="fa fa-file-excel-o"></i> <?=$this->lang->line('application_origem_export')?></a><br><br>
                        <a href="<?=base_url('export/fabricantesxls') ?>"><i class="fa fa-file-excel-o"></i> <?=$this->lang->line('application_brands_export')?></a><br><br>
                        <a href="<?=base_url('export/categoriesxls') ?>"><i class="fa fa-file-excel-o"></i> <?=$this->lang->line('application_categories_export')?></a>
                    <?php endif; ?>
                </div>
                <?php if(!isset($validate_finish)): ?>
                    <div class="col-md-6 col-xs-12">
                        <?= $this->lang->line('application_import_product_step_3') ?>
                        <hr>
                        <form role="form" action="<?php echo base_url('ProductsLoadByCSV/onlyVerify') ?>" method="post" enctype="multipart/form-data" id="upload-file">
                ...
                <table class="table table-striped table-warning table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $this->lang->line('application_required_more_zero') ?></td>
                        </tr>
                        <tr>
                            <td>Quantidade em estoque</td>
                            <td><?= $this->lang->line('application_optional_great_positive_default_zero') ?></td>
                        </tr>
                        <tr>
                            <td>Fabricante</td>
                            <td><?= $this->lang->line('application_required') ?> <a class="btn btn-warning font-weight-bold pt-0 pb-0 ml-3" href="<?=base_url('export/fabricantesxls') ?>"><?=$this->lang->line('application_brands_export')?></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Categoria</td>
                            <td><?= $this->lang->line('application_required') ?><a class="btn btn-warning font-weight-bold pt-0 pb-0 ml-3" href="<?=base_url('export/categoriesxls') ?>"><?=$this->lang->line('application_categories_export')?></a></td>
                        </tr>
                        <tr>
                            <td>EAN</td>
                            <td><?=$this->lang->line('application_optional_ean')?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>NCM</td>
                            <td><?= $this->lang->line('application_optional_ncm') ?></td>
                        </tr>
                        <tr>
                            <td>Origem do Produto _ Nacional ou Estrangeiro</td>
                            <td><?= $this->lang->line('application_required_origin') ?> <a class="btn btn-warning font-weight-bold pt-0 pb-0 ml-3" href="<?=base_url('export/origemxls') ?>"><?=$this->lang->line('application_origem_export')?></a></td>
                        </tr>
                        <tr>
                            <td>Garantia em meses</td>
                            <td><?= $this->lang->line('application_optional_default_zero') ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?= $this->lang->line('application_optional_default_one') ?></td>
                        </tr>
                        <tr>
                            <td>Descricao do Item _ Informacoes do Produto</td>
                            <td><?= $this->lang->line('application_description_import_csv_label') ?></td>
                        </tr>
                        <tr>
                            <td>Imagens</td>
                            <td><?= $this->lang->line('application_image_import_csv_label') ?></td>
                        </tr>
                        <tr>
                            <td>Status(1=Ativo|2=Inativo|3=Lixeira)</td>
                            <td><?= $this->lang->line('application_status_import_csv_label') ?></td>
                        </tr>
                    </tbody>
                </table>
                <h5 class="font-weight-bold"><?=$this->lang->line('messages_completed_fields_and_rules_variation')?></h5>
                <table class="table table-striped table-warning table-bordered">
                    <thead>
                        <tr>
                            <th><?=$this->lang->line('application_field')?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Status(1=Ativo|2=Inativo|3=Lixeira)</td>
                            <td><?= $this->lang->line('application_status_import_csv_label_var') ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
