    ...
    <div class="row">
        <div class="col-md-3 col-xs-12">
            <div class="box box-alert alert alert-warning ">
                <div class="box-body">
                    <?= $this->lang->line('application_import_rules_sync_marketplace_sku') ?>
        ...
        <div class="box box">
            <div class="box-body">
                <div class="col-md-3 col-xs-12">
                    ...
                    <hr>
                    <a download="sample_sync_skuseller_skumkt.csv" href="<?=base_url('assets/files/sample_sync_skuseller_skumkt.csv') ?>"><i class="fa fa-download"></i>  <?=$this->lang->line('application_sample_sync_skuseller_skumkt');?></a><br><br>
                </div>
                <div class="col-md-3 col-xs-12">
                ...
                <?php if(!isset($validate_finish)): ?>
                    <div class="col-md-6 col-xs-12">
                        <?= $this->lang->line('application_import_sync_skuseller_skumkt_step_3') ?>
                        <hr>
                        <form role="form" action="<?php echo base_url('ProductsLoadByCSV/onlyVerifySyncPublishedSku') ?>" method="post" enctype="multipart/form-data" id="upload-file">
            ...
            <div class="box box-defaut box-body alert alert-warning alert-dismissible">
                ...
                <table class="table table-striped table-warning table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Sku no seller center</td>
                            <td><?= $this->lang->line('application_required') ?></td>
                        </tr>
                        <tr>
                            <td>Sku no marketplace</td>
                            <td><?= $this->lang->line('application_required') ?></td>
                        </tr>
                        <tr>
                            <td>Marketplace</td>
