        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    ...
                    <form action="<?php base_url('products/update') ?>" method="post" enctype="multipart/form-data" id="formUpdateProduct">
                        <?php } else { ?>
                        <form action="<?= base_url('products/create') ?>" method="post" enctype="multipart/form-data" id="formUpdateProduct">
                            <?php } ?>
                            <input type="hidden" name="copy_prod_data" value="<?= $product_data['copy_prod_data'] ?? false ?>">
                            <div class="box-body">
                                ...
                                if ($product_data['status'] == 4) { ?>
                                    <div class="alert alert-danger alert-dismissible" role="alert">
                                        ...
                                        <?php foreach ($product_data['rule'] as $rule) {
                                            if ($this->session->userdata('usercomp') == 1) {echo $rule['blacklist_id'] . ' - ';}
                                ...
                                <div class="form-group col-md-12 col-xs-12">
                                    ...
                                    <div class="kv-avatar">
                                        <div class="file-loading">
                                            <input type="file" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> id="prd_image" name="prd_image[]" accept="image/png, image/jpeg" multiple>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group col-md-6 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> id="product_name" onkeyup="characterLimit(this)" maxlength="<?= $product_length_name ?>" onchange="verifyWords()" name="product_name" required placeholder="<?= $this->lang->line('application_enter_product_name'); ?>" value="<?php echo set_value('product_name', $product_data['name']); ?>" autocomplete="off" />
                                ...
                                <input type="hidden" name="has_integration" value="<?= (!$storeCanUpdateProduct && $notAdmin ? true : false) ?>" />

                                <div class="form-group col-md-3 col-xs-12">
                                    <label for="sku"><?= $this->lang->line('application_sku'); ?>(*)</label>
                                    <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control" id="sku" name="sku" maxlength="<?= $product_length_sku ?>" required placeholder="<?= $this->lang->line('application_enter_sku'); ?>" value="<?php echo set_value('sku', $product_data['sku']); ?>" autocomplete="off" onKeyUp="checkSpecialSku(event, this);characterLimit(this);" onblur="checkSpecialSku(event, this);" />
                                ...
                                <div class="form-group col-md-12 col-xs-12">
                                    ...
                                    <div class="form-check col-md-2 col-xs-12">
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            ...
                                            <input type="hidden" id="semvar" name="semvar" value="<?= $product_data['has_variants'] == '' ? 'on' : 'off'; ?>">
                                        <?php } else { ?>
                                    ...
                                    <div class="form-check col-md-2 col-xs-12">
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            <input type="checkbox" disabled class="form-check-input checkbox-limited" <?= set_checkbox('sizevar', 'on', (strpos($product_data['has_variants'], "TAMANHO") !== false)) ?>>
                                        ...
                                        <?php } else { ?>
                                            <input type="checkbox" class="form-check-input checkbox-limited" id="sizevar" name="sizevar" <?= set_checkbox('sizevar', 'on', (strpos($product_data['has_variants'], "TAMANHO") !== false)) ?>>
                                        <?php } ?>
                                        <label for="sizevar"><?= $this->lang->line('application_size'); ?></label>
                                    </div>
                                    <div class="form-check col-md-2 col-xs-12">
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            <input type="checkbox" disabled class="form-check-input checkbox-limited" <?= set_checkbox('colorvar', 'on', (strpos($product_data['has_variants'], "Cor") !== false)) ? 'checked' : ''; ?>>
                                        ...
                                        <?php } else { ?>
                                            <input type="checkbox" class="form-check-input checkbox-limited" id="colorvar" name="colorvar" <?= set_checkbox('colorvar', 'on', (strpos($product_data['has_variants'], "Cor") !== false)) ? 'checked' : ''; ?>>
                                        <?php } ?>
                                        <label for="colorvar"><?= $this->lang->line('application_color'); ?></label>
                                    </div>
                                    <div class="form-check col-md-2 col-xs-12">
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            <input type="checkbox" disabled class="form-check-input checkbox-limited" <?= set_checkbox('voltvar', 'on', (strpos($product_data['has_variants'], "VOLTAGEM") !== false)) ? 'checked' : ''; ?>>
                                        ...
                                        <?php } else { ?>
                                            <input type="checkbox" class="form-check-input checkbox-limited" id="voltvar" name="voltvar" <?= set_checkbox('voltvar', 'on', (strpos($product_data['has_variants'], "VOLTAGEM") !== false)) ? 'checked' : ''; ?>>
                                        <?php } ?>
                                        <label for="voltvar"><?= $this->lang->line('application_voltage'); ?></label>
                                    </div>
                                    <div class="form-check col-md-2 col-xs-12" <?= (isset($flavor_active) == '' ? 'hidden': '') ?>>
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            <input type="checkbox" disabled class="form-check-input checkbox-limited" <?= set_checkbox('saborvar', 'on', (strpos($product_data['has_variants'], "SABOR") !== false)) ? 'checked' : ''; ?>>
                                        ...
                                        <?php } else { ?>
                                            <input type="checkbox" class="form-check-input checkbox-limited" id="saborvar" name="saborvar" <?= set_checkbox('saborvar', 'on', (strpos($product_data['has_variants'], "SABOR") !== false)) ? 'checked' : ''; ?>>
                                        <?php } ?>
                                        <label for="saborvar"><?= $this->lang->line('application_flavor'); ?></label>
                                    </div>
                                    <div class="form-check col-md-2 col-xs-12" <?= (isset($degree_active) == '' ? 'hidden': '') ?>>
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            <input type="checkbox" disabled class="form-check-input checkbox-limited" <?= set_checkbox('grauvar', 'on', (strpos($product_data['has_variants'], "GRAU") !== false)) ? 'checked' : ''; ?>>
                                        ...
                                        <?php } else { ?>
                                            <input type="checkbox" class="form-check-input checkbox-limited" id="grauvar" name="grauvar" <?= set_checkbox('grauvar', 'on', (strpos($product_data['has_variants'], "GRAU") !== false)) ? 'checked' : ''; ?>>
                                        <?php } ?>
                                        <label for="grauvar"><?= $this->lang->line('application_degree'); ?></label>
                                    </div>
                                    <div class="form-check col-md-2 col-xs-12" <?= (isset($side_active) == '' ? 'hidden': '') ?>>
                                        <?php if (!$storeCanUpdateProduct) { ?>
                                            <input type="checkbox" disabled class="form-check-input checkbox-limited" <?= set_checkbox('ladovar', 'on', (strpos($product_data['has_variants'], "LADO") !== false)) ? 'checked' : ''; ?>>
                                        ...
                                        <?php } else { ?>
                                            <input type="checkbox" class="form-check-input checkbox-limited" id="ladovar" name="ladovar" <?= set_checkbox('ladovar', 'on', (strpos($product_data['has_variants'], "LADO") !== false)) ? 'checked' : ''; ?>>
                                        <?php } ?>
                                ...
                                <div id="variantModal" class="col-md-12 col-xs-12" style="display:none;">
                                    <hr class="row">
                                    <input type="hidden" name="numvar" id="numvar" value="<?php echo set_value('numvar', $product_variants['numvars'] + 1); ?>" />
                                    ...
                                    <div class="container-fluid col-person-one" id="variant1">
                                        <div id="Invar1" class="col-md-1" style="padding-left: 0px;padding-right: 3px;width:auto;">
                                            <span class="form-control label label-success">0</span>
                                        </div>
                                        <div id="Itvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                            <input type="text" class="form-control" id="T[]" name="T[]" placeholder="<?= $this->lang->line('application_size') ?>" autocomplete="off" value="<?php echo set_value('T[0]', (isset($product_variants[0]['TAMANHO'])) ? $product_variants[0]['TAMANHO'] : ""); ?>" <?= !$storeCanUpdateProduct ? 'readonly' : '' ?> />
                                        </div>
                                        <div id="Icvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                            <input type="text" class="form-control" id="C[]" name="C[]" placeholder="<?= $this->lang->line('application_color') ?>" autocomplete="off" value="<?php echo set_value('C[0]', (isset($product_variants[0]['Cor'])) ? $product_variants[0]['Cor'] : ""); ?>" <?= !$storeCanUpdateProduct ? 'readonly' : '' ?> />
                                        </div>
                                        <div id="Ivvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                            <input type="text" class="form-control" id="V[]" name="V[]" autocomplete="off" placeholder="<?= $this->lang->line('application_voltage'); ?>" value="<?php echo set_value('V[0]', (isset($product_variants[0]['VOLTAGEM'])) ? $product_variants[0]['VOLTAGEM'] : ""); ?>" <?= !$storeCanUpdateProduct ? 'readonly' : '' ?>/>
                                        </div>
                                        <?php if($flavor_active) { ?>
                                            <div id="Isvar" class="col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                                <input type="text" class="form-control" id="sb[]" name="sb[]" autocomplete="off" placeholder="<?= $this->lang->line('application_flavor'); ?>" value="<?php echo set_value('sb[0]', (isset($product_variants[0]['SABOR'])) ? $product_variants[0]['SABOR'] : ""); ?>" />
                                            </div>
                                        <?php } ?>
                                        <?php if($degree_active) { ?>
                                            <div id="Igvar" class="col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                                <input type="text" class="form-control" id="gr[]" name="gr[]" autocomplete="off" placeholder="<?= $this->lang->line('application_degree'); ?>" value="<?php echo set_value('gr[0]', (isset($product_variants[0]['GRAU'])) ? $product_variants[0]['GRAU'] : ""); ?>" />
                                            </div>
                                        <?php } ?>
                                        <?php if($side_active) { ?>
                                            <div id="Ilvar" class="col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                                <input type="text" class="form-control" id="ld[]" name="ld[]" autocomplete="off" placeholder="<?= $this->lang->line('application_side'); ?>" value="<?php echo set_value('ld[0]', (isset($product_variants[0]['LADO'])) ? $product_variants[0]['LADO'] : ""); ?>" />
                                            </div>
                                        <?php } ?>
                                        <div id="Iqvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                            <input type="text" class="form-control" id="Q[]" name="Q[]" placeholder="<?= $this->lang->line('application_stock') ?>" autocomplete="off" value="<?php echo set_value('Q[0]', (isset($product_variants[0]['qty'])) ? $product_variants[0]['qty'] : ""); ?>" onKeyPress="return digitos(event, this);" />
                                        </div>
                                        <div id="Iskuvar" class="form-group col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                            <input type="text" class="form-control" id="SKU_V_0" name="SKU_V[]" placeholder="SKU Variação" autocomplete="off" value="<?php echo set_value('SKU_V[0]', (isset($product_variants[0]['sku'])) ? $product_variants[0]['sku'] : ""); ?>" onKeyUp="checkSpecialSku(event, this);characterLimit(this);" onblur="checkSpecialSku(event, this);" maxlength="<?= $product_length_sku ?>" />
                                            <span id="char_SKU_V_<?= 0 ?>"></span><br />
                                        </div>
                                        <div id="EANV0" class="Ieanvar form-group col-md-2  <?php echo (form_error('EAN_V[0]')) ? 'has-error' : '';  ?>" style="padding-left: 0px;padding-right: 3px;">
                                            <input type="text" class="form-control" id="EAN_V[]" name="EAN_V[]" placeholder="EAN Variação" autocomplete="off" onchange="checkEAN(this.value,'EANV0','<?= $product_data['id']; ?>')" value="<?php echo set_value('EAN_V[0]', (isset($product_variants[0]['EAN'])) ? $product_variants[0]['EAN'] : ""); ?>" />
                                        ...
                                        <?php if ($displayPriceByVariation == '1') { ?>
                                            <div id="Ilistpricevar" class="form-group col-md-1 Ilistpricevar  <?php echo (form_error('LIST_PRICE_V[0]')) ? 'has-error' : '';  ?> " style="padding-left: 0px;padding-right: 3px;">
                                                <input type="text" class="form-control maskdecimal2" id="LIST_PRICE_V[]" name="LIST_PRICE_V[]" placeholder="Preço De - Variação" autocomplete="off" value="<?php echo set_value('LIST_PRICE_V[0]', (isset($product_variants[0]['list_price'])) ? $product_variants[0]['list_price'] : ""); ?>" />
                                                <?php echo '<i style="color:red">' . form_error('LIST_PRICE_V[0]') . '</i>'; ?>
                                            </div>
                                            <div id="Ipricevar" class="form-group col-md-1 Ipricevar  <?php echo (form_error('PRICE_V[0]')) ? 'has-error' : '';  ?> " style="padding-left: 0px;padding-right: 3px;">
                                                <input type="text" class="form-control maskdecimal2" id="PRICE_V[]" name="PRICE_V[]" placeholder="Preço Por - Variação" autocomplete="off" value="<?php echo set_value('PRICE_V[0]', (isset($product_variants[0]['price'])) ? $product_variants[0]['price'] : ""); ?>" />
                                        ...
                                        <div class="col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                            ...
                                            ?>
                                            <input type="hidden" id="IMAGEM0" name="IMAGEM[]" value="<?php echo set_value('IMAGEM[0]', $imagevariant0) ?>" />

                                            <?php if (!$storeCanUpdateProduct && $notAdmin) { ?>
                                                <a href="#" onclick="AddImage(event,'0')"><img alt="foto" id="foto_variant0" src="<?= $imagem; ?>" class="img-rounded" width="40" height="40" /></a>
                                            <?php  } else { ?>
                                                <a href="#" onclick="AddImage(event,'0')"><img alt="foto" id="foto_variant0" src="<?= $imagem; ?>" class="img-rounded" width="40" height="40" /><i class="fa fa-plus-circle" style="margin-left: 6px"></i></a>
                                            <?php  }  ?>
                                    ...
                                    <div class="input_fields_wrap">
                                        <?php for ($i = 1; $i <= $product_variants['numvars']; $i++) { ?>
                                            <div class="container-fluid col-person-two" id="variant<?php echo $i + 1; ?>">
                                                <div id="Invar<?php echo $i + 1; ?>" class="col-md-1" style="padding-left: 0px;padding-right: 3px;width:auto;">
                                                    <span class="form-control label label-success"><?php echo $i; ?></span>                                                    
                                                </div>
                                                <div id="Itvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                                    <input type="text" class="form-control" id="T[]" placeholder="<?= $this->lang->line('application_size') ?>" name="T[]" autocomplete="off" value="<?php echo set_value('T[' . $i . ']', (isset($product_variants[$i]['TAMANHO'])) ? $product_variants[$i]['TAMANHO'] : ""); ?>" <?= !$storeCanUpdateProduct ? 'readonly' : '' ?> />
                                                </div>
                                                <div id="Icvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                                    <input type="text" class="form-control" id="C[]" placeholder="<?= $this->lang->line('application_color') ?>" name="C[]" autocomplete="off" value="<?php echo set_value('C[' . $i . ']', (isset($product_variants[$i]['Cor'])) ? $product_variants[$i]['Cor'] : ""); ?>" <?= !$storeCanUpdateProduct ? 'readonly' : '' ?> />
                                                </div>
                                                <div id="Ivvar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                                    <input type="text" class="form-control" id="V[]" name="V[]" autocomplete="off" placeholder="<?= $this->lang->line('application_voltage'); ?>" value="<?php echo set_value('V[' . $i . ']', (isset($product_variants[$i]['VOLTAGEM'])) ? $product_variants[$i]['VOLTAGEM'] : ""); ?>" <?= !$storeCanUpdateProduct ? 'readonly' : '' ?> />
                                                </div>
                                                <?php if($flavor_active) { ?>
                                                    <div id="Isvar" class="col-md-1" style="padding-left: 0px;padding-right: 3px;" <?= ($flavor_active == '' ? 'hidden': '') ?>>
                                                        <input type="text" class="form-control" id="sb[]" name="sb[]" autocomplete="off" placeholder="<?= $this->lang->line('application_flavor'); ?>" value="<?php echo set_value('sb[' . $i . ']', (isset($product_variants[$i]['SABOR'])) ? $product_variants[$i]['SABOR'] : ""); ?>" />
                                                    </div>
                                                <?php } ?>
                                                <?php if($degree_active) { ?>
                                                    <div id="Igvar" class="col-md-1" style="padding-left: 0px;padding-right: 3px;" <?= ($degree_active == '' ? 'hidden': '') ?>>
                                                        <input type="text" class="form-control" id="gr[]" name="gr[]" autocomplete="off" placeholder="<?= $this->lang->line('application_degree'); ?>" value="<?php echo set_value('gr[' . $i . ']', (isset($product_variants[$i]['GRAU'])) ? $product_variants[$i]['GRAU'] : ""); ?>" />
                                                    </div>
                                                <?php } ?>
                                                <?php if($side_active) { ?>
                                                    <div id="Ilvar" class="col-md-1" style="padding-left: 0px;padding-right: 3px;" <?= ($side_active == '' ? 'hidden': '') ?>>
                                                        <input type="text" class="form-control" id="ld[]" name="ld[]" autocomplete="off" placeholder="<?= $this->lang->line('application_side'); ?>" value="<?php echo set_value('ld[' . $i . ']', (isset($product_variants[$i]['LADO'])) ? $product_variants[$i]['LADO'] : ""); ?>" />
                                                    </div>
                                                <?php } ?>
                                                <div id="Iqvar" class="form-group col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                                    <input type="text" class="form-control" id="Q[]" name="Q[]" placeholder="<?= $this->lang->line('application_stock') ?>" autocomplete="off" value="<?php echo set_value('Q[' . $i . ']', (isset($product_variants[$i]['qty'])) ? $product_variants[$i]['qty'] : ""); ?>" onKeyPress="return digitos(event, this);" />
                                                </div>
                                                <div id="Iskuvar" class="form-group col-md-1" style="padding-left: 0px;padding-right: 3px;">
                                                    <input type="text" class="form-control" id="SKU_V_<?= $i ?>" name="SKU_V[]" placeholder="SKU Variação" autocomplete="off" value="<?php echo set_value('SKU_V[' . $i . ']', (isset($product_variants[$i]['sku'])) ? $product_variants[$i]['sku'] : ""); ?>" onKeyUp="checkSpecialSku(event, this);characterLimit(this);" onblur="checkSpecialSku(event, this);" maxlength="<?= $product_length_sku ?>" />
                                                    <span id="char_SKU_V_<?= $i ?>"></span><br />
                                                </div>
                                                <div id="EANV<?php echo $i; ?>" class="Ieanvar form-group col-md-2" style="padding-left: 0px;padding-right: 3px;">
                                                    <input type="text" class="form-control" id="EAN_V[]" onKeyPress="return digitos(event, this);" name="EAN_V[]" placeholder="EAN Variação" autocomplete="off" onchange="checkEAN(this.value,'EANV<?php echo $i; ?>','<?= $product_data['id']; ?>')" value="<?php echo set_value('EAN_V[' . $i . ']', (isset($product_variants[$i]['EAN'])) ? $product_variants[$i]['EAN'] : ""); ?>" />
                                                ...
                                                <?php if ($displayPriceByVariation == '1') { ?>
                                                    <div id="Ilistpricevar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                                        <input type="text" class="form-control maskdecimal2" id="LIST_PRICE_V[]" name="LIST_PRICE_V[]" placeholder="Preço De - Variação" autocomplete="off" value="<?php echo set_value('LIST_PRICE_V[' . $i . ']', (isset($product_variants[$i]['list_price'])) ? $product_variants[$i]['list_price'] : ""); ?>" />
                                                    </div>
                                                    <div id="Ipricevar" class="form-group col-md-1 " style="padding-left: 0px;padding-right: 3px;">
                                                        <input type="text" class="form-control maskdecimal2" id="PRICE_V[]" name="PRICE_V[]" placeholder="Preço Por - Variação" autocomplete="off" value="<?php echo set_value('PRICE_V[' . $i . ']', (isset($product_variants[$i]['price'])) ? $product_variants[$i]['price'] : ""); ?>" />
                                                    </div>
                                                <?php } ?>
                                                <div class="col-md-1 " style="padding-left: 0px;padding-right: 3px;width:auto;">
                                                    ...
                                                    <?php if (!$storeCanUpdateProduct && $notAdmin) { ?>
                                                        <a href="#" onclick="AddImage(event,'<?php echo $i; ?>')"><img alt="foto" id="foto_variant<?php echo $i; ?>" src="<?= $imagem; ?>" class="img-rounded" width="40" height="40" /></a>
                                                    <?php  } else { ?>
                                                        <a href="#" onclick="AddImage(event,'<?php echo $i; ?>')"><img alt="foto" id="foto_variant<?php echo $i; ?>" src="<?= $imagem; ?>" class="img-rounded" width="40" height="40" /><i class="fa fa-plus-circle" style="margin-left: 6px"></i></a>
                                                    <?php  }
                                                    ?>
                                                </div>
                                ...
                                <div class="form-group col-md-12 col-xs-12 <?php echo (form_error('description')) ? 'has-error' : '';  ?>">
                                    ...
                                    <textarea type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control" id="description" maxlength="<?= $product_length_description ?>" name="description" placeholder="<?= $this->lang->line('application_enter_description'); ?>"><?php echo $product_data['description']; ?></textarea>
                                ...
                                <?php if (!isset($promotion) && count($campaigns) == 0) { ?>
                                    <div class="form-group col-md-2 col-xs-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control maskdecimal2" id="list_price" name="list_price" placeholder="<?= $this->lang->line('application_enter_price'); ?>" value="<?php echo set_value('list_price', $product_data['list_price']);?>" autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3 col-xs-12">
                                        ...
                                        <label for="price" class="d-flex justify-content-between">
                                            ...
                                            <?php if (($product_data['status'] == 1) && ($product_data['situacao'] == 2)) { ?>
                                                <a href="<?php echo base_url('promotions/createpromo/' . $product_data['id']) ?>"><i class="fa fa-plus-circle"> <?= $this->lang->line('application_add_promotion') ?></i></a>
                                            <?php } ?>

                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>R$</strong></span>
                                            <input type="text" class="form-control maskdecimal2" id="price" name="price" required placeholder="<?= $this->lang->line('application_enter_price'); ?>" value="<?php echo set_value('price', number_format($product_data['price'], 2)); ?>" autocomplete="off" />
                                        </div>
                                        <?php if ($product_data['competitiveness']) { ?>
                                            <span class="label label-danger" data-toggle="tooltip" title="<?= $this->lang->line('application_reduce_product_value') ?>">Produto <?= number_format($product_data['competitiveness'], 2, ',', '.') ?>% acima do valor de mercado</span>
                                        <?php } ?>
                                        <div class="input-group">
                                            <?php
                                                        ...
                                                        if (($product_marketplace['variant'] == '0') || ($product_marketplace['variant'] == '')) {
                                                            ...
                                                            <tr>
                                                                <td style="width: 40%"><?php echo $product_marketplace['int_to']; ?>
                                                                    <br>
                                                                    <input type="checkbox" name="samePrice_<?= $product_marketplace['int_to'] ?>" <?= set_checkbox('samePrice_' . $product_marketplace['int_to'], 'on', $product_marketplace['same_price'] == 1) ?> id="samePrice_<?= $product_marketplace['int_to'] ?>" onchange="samePrice('<?= $product_marketplace['int_to'] ?>')">
                                                                    <small><?= $this->lang->line('application_same_price'); ?></small>
                                                                </td>
                                                                <td>
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><small><strong>R$</strong></small></span>
                                                                        <input type="text" <?= $disablePrice ?> class="form-control maskdecimal2" id="price_<?= $product_marketplace['int_to'] ?>" name="price_<?= $product_marketplace['int_to'] ?>" required placeholder="<?= $this->lang->line('application_enter_price'); ?>" value="<?php echo set_value('price_' . $product_marketplace['int_to'], $product_marketplace['price']); ?>" autocomplete="off" />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <?php
                                ...
                                <div class="form-group col-md-2 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" id="qty" name="qty" required placeholder="<?= $this->lang->line('application_enter_qty'); ?>" value="<?php echo set_value('qty', $product_data['qty']); ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                                ...
                                                foreach ($products_marketplace as $product_marketplace) {
                                                    ...
                                                    if ($product_marketplace['hub']) {
                                                        ...
                                                        <tr>
                                                            <td style="width: 40%"><?php echo $product_marketplace['int_to']; ?>
                                                                <br>
                                                                <input type="checkbox" name="sameQty_<?= $product_marketplace['int_to'] ?>" <?= set_checkbox('sameQty_' . $product_marketplace['int_to'], 'on', $product_marketplace['same_qty'] == 1) ?> id="sameQty_<?= $product_marketplace['int_to'] ?>" onchange="sameQty('<?= $product_marketplace['int_to'] ?>')">
                                                            ...
                                                            <td>
                                                                <input type="text" <?= $disableQty ?> class="form-control" id="qty_<?= $product_marketplace['int_to'] ?>" onKeyPress="return digitos(event, this)" onchange="changeQtyMkt(<?= $product_marketplace['int_to'] ?>)" name="qty_<?= $product_marketplace['int_to'] ?>" required placeholder="<?= $this->lang->line('application_enter_qty'); ?>" value="<?php echo set_value('qty_' . $product_marketplace['int_to'], $product_marketplace['qty']); ?>" autocomplete="off" />
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                                ...
                                <div id="EANDIV" class="form-group col-md-3 col-xs-12 <?php echo (form_error('EAN')) ? 'has-error' : '';  ?>">
                                    ...
                                    <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> <?= ($require_ean) ? "required" : "" ?> class="form-control" id="EAN" name="EAN" onchange="checkEAN(this.value,'EANDIV','<?= $product_data['id']; ?>')" placeholder="<?= $this->lang->line('application_enter_ean'); ?>" value="<?php echo set_value('EAN', $product_data['EAN']); ?>" autocomplete="off" />
                                ...
                                <div class="form-group col-md-2 col-xs-12">
                                    ...
                                    <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control" id="codigo_do_fabricante" name="codigo_do_fabricante" placeholder="<?= $this->lang->line('application_enter_manufacturer_code'); ?>" value="<?php echo set_value('codigo_do_fabricante', $product_data['codigo_do_fabricante']); ?>" autocomplete="off" />
                                </div>
                                <div class="row"></div>
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group col-md-3 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal3" id="peso_bruto" name="peso_bruto" required placeholder="<?= $this->lang->line('application_enter_gross_weight'); ?>" value="<?php echo set_value('peso_bruto', $product_data['peso_bruto']); ?>" autocomplete="off" />
                                        ...
                                        <div class="form-group col-md-2 col-xs-12 <?php echo (form_error('largura')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal2" id="largura" name="largura" required placeholder="<?= $this->lang->line('application_enter_width'); ?>" value="<?php echo set_value('largura', $product_data['largura']); ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                        ...
                                        <div class="form-group col-md-2 col-xs-12 <?php echo (form_error('altura')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal2" id="altura" name="altura" required placeholder="<?= $this->lang->line('application_enter_height'); ?>" value="<?php echo set_value('altura', $product_data['altura']); ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                                <span class="input-group-addon"><strong>cm</strong></span>
                                            </div>
                                        ...
                                        <div class="form-group col-md-2 col-xs-12 <?php echo (form_error('profundidade')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal2" id="profundidade" name="profundidade" required placeholder="<?= $this->lang->line('application_enter_depth'); ?>" value="<?php echo set_value('profundidade', $product_data['profundidade']); ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                                <span class="input-group-addon"><strong>cm</strong></span>
                                            </div>
                                        ...
                                        <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('products_package')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal3" id="products_package" name="products_package" required placeholder="<?= $this->lang->line('application_enter_quantity_products'); ?>" value="<?php echo set_value('products_package', $product_data['products_package']) ?>" autocomplete="off" />
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group col-md-3 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal3" id="peso_liquido" name="peso_liquido" required placeholder="<?= $this->lang->line('application_enter_net_weight'); ?>" value="<?php echo set_value('peso_liquido', $product_data['peso_liquido']); ?>" autocomplete="off" />
                                                <span class="input-group-addon"><strong>Kg</strong></span>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('actual_width')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal2" id="actual_width" name="actual_width" placeholder="<?= $this->lang->line('application_enter_actual_width'); ?>" value="<?php echo set_value('actual_width', $product_data['actual_width']) ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                                <span class="input-group-addon"><strong>cm</strong></span>
                                            </div>
                                        ...
                                        <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('actual_height')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal2" id="actual_height" name="actual_height" placeholder="<?= $this->lang->line('application_enter_actual_height'); ?>" value="<?php echo set_value('actual_height', $product_data['actual_height']) ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                                <span class="input-group-addon"><strong>cm</strong></span>
                                            </div>
                                        ...
                                        <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('actual_depth')) ? 'has-error' : '';  ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control maskdecimal2" id="actual_depth" name="actual_depth" placeholder="<?= $this->lang->line('application_enter_actual_depth'); ?>" value="<?php echo set_value('actual_depth', $product_data['actual_depth']) ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                                <span class="input-group-addon"><strong>cm</strong></span>
                                            </div>
                                ...
                                <div class="form-group col-md-3 col-xs-12">
                                    ...
                                    <input type="text" <?= (!$storeCanUpdateProduct && $notAdmin ? 'readonly' : '') ?> class="form-control" id="garantia" name="garantia" required placeholder="<?= $this->lang->line('application_enter_warranty'); ?>" value="<?php echo set_value('garantia', $product_data['garantia']); ?>" autocomplete="off" onKeyPress="return digitos(event, this);" />
                                </div>

                                <div class="form-group col-md-3 col-xs-12">
                                    <label for="NCM"><?= $this->lang->line('application_NCM'); ?></label>
                                    <input type="text" class="form-control" id="NCM" name="NCM" placeholder="<?= $this->lang->line('application_enter_NCM'); ?>" value="<?php echo set_value('NCM', $product_data['NCM']); ?>" maxlength="10" size="10" onKeyPress="return digitos(event, this);" onKeyDown="Mascara('NCM',this,event);" autocomplete="off" />
                                </div>
...
?>
                            ...
                            <div class="form-group col-md-9 col-xs-12">
                                ...
                                <input type='hidden' id='id_categoria' name="category[]" value="<?php echo $idCategory_id; ?>">
                                ...
                                <?= (in_array('disabledCategoryPermission', $this->permission) == true) ? 'disabled readonly' : '' ?>>
                                    ...
                                    <?php foreach ($category as $k => $v) {
                                        $disabledCategory = (!$storeCanUpdateProduct && (!in_array($v['id'], $category_data)) && $notAdmin) ? 'disabled' : ''; $blocked_cross_docking = $v['blocked_cross_docking']; $days_cross_docking=$v['days_cross_docking']; ?>
                            ...
                            <div class="form-group col-md-3 col-xs-12">
                                ...
                                <input type="number" class="form-control" maxlength="2" id="days" name="prazo_operacional_extra" placeholder="<?= $this->lang->line('application_extra_operating_time'); ?>" value="<?php echo set_value('prazo_operacional_extra', $prazo) ?>" autocomplete="off" onKeyPress="return digitos(event, this);"  />
                                                            ...
                                                            <td style="">
                                                                <?php if ($integracao['approved'] != 4) : ?>
                                                                    <?php if ($integracao['approved'] != 1) : ?>
                                                                        <button onclick="changeIntegrationApproval(event,'<?= $integracao['id'] ?>','<?= $product_data['id'] ?>','1','<?= $integracao['approved'] ?>','<?= $integracao['int_to'] ?>')" class="btn btn-success btn-sm"><?= $this->lang->line('application_approve'); ?></button>
                                                                    <?php endif ?>
                                                                    <?php if ($integracao['approved'] != 2) : ?>
                                                                        <button onclick="changeIntegrationApproval(event,'<?= $integracao['id'] ?>','<?= $product_data['id'] ?>','2','<?= $integracao['approved'] ?>','<?= $integracao['int_to'] ?>')" class="btn btn-danger btn-sm"><?= $this->lang->line('application_disapprove'); ?></button>
                                                                    <?php endif ?>
                                                                    <?php if ($integracao['approved'] != 3) : ?>
                                                                        <button onclick="changeIntegrationApproval(event,'<?= $integracao['id'] ?>','<?= $product_data['id'] ?>','3','<?= $integracao['approved'] ?>','<?= $integracao['int_to'] ?>')" class="btn btn-primary btn-sm"><?= $this->lang->line('application_mark_as_in_approval'); ?></button>
                                                                    <?php endif ?>
                                                                <?php endif ?>
                                                            </td>
                  ...
                  <div class="form-group col-md-12 col-xs-12">
                      <div class="row">
                          <div class="form-group col-md-12 col-xs-12">
                              <h4><?= $this->lang->line('application_dimensions_freight_calculation'); ?></h4>
                              <label><?= $this->lang->line('application_measures_packaged_product_shipping'); ?></label>
                          </div>
                      </div>

                      <div class="row">
                          <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('largura_embalado')) ? 'has-error' : '';  ?>">
                              <label for="largura_embalado"><?= $this->lang->line('application_width_packing'); ?> - MIN:11cm</label>
                              <input type="text" class="form-control maskdecimal2" id="largura_embalado" name="largura_embalado" placeholder="<?= $this->lang->line('application_enter_width'); ?>" value="<?php echo set_value('largura_embalado', $product_data['largura_embalado']); ?>"  autocomplete="off" onKeyPress="return digitos(event, this);" />
                              <?php echo '<i style="color:red">' . form_error('largura_embalado') . '</i>'; ?>
                          </div>
                          <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('altura_embalado')) ? 'has-error' : '';  ?>">
                              <label for="altura_embalado"><?= $this->lang->line('application_height_packing'); ?> - MIN:2cm</label>
                              <input type="text" class="form-control maskdecimal2" id="altura_embalado" name="altura_embalado" placeholder="<?= $this->lang->line('application_enter_height'); ?>" value="<?= set_value('altura_embalado', $product_data['altura_embalado']); ?>"  autocomplete="off" onKeyPress="return digitos(event, this);" />
                              <?php echo '<i style="color:red">' . form_error('altura_embalado') . '</i>'; ?>
                          </div>
                          <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('profundidade_embalado')) ? 'has-error' : '';  ?>">
                              <label for="profundidade_embalado"><?= $this->lang->line('application_depth_packing'); ?> - MIN:16cm</label>
                              <input type="text" class="form-control maskdecimal2" id="profundidade_embalado" name="profundidade_embalado" placeholder="<?= $this->lang->line('application_enter_depth'); ?>" value="<?= set_value('profundidade_embalado', $product_data['profundidade_embalado']); ?>"  autocomplete="off" onKeyPress="return digitos(event, this);" />
                              <?php echo '<i style="color:red">' . form_error('profundidade_embalado') . '</i>'; ?>
                          </div>
                          <div class="form-group col-md-3 col-xs-12 <?php echo (form_error('peso_embalado')) ? 'has-error' : '';  ?>">
                              <label for="peso_embalado"><?= $this->lang->line('application_weight_total_packing'); ?></label>
                              <input type="text" class="form-control maskdecimal3" id="peso_embalado" name="peso_embalado" placeholder="<?= $this->lang->line('application_enter_weight_total'); ?>" value="<?= set_value('peso_embalado', $product_data['peso_embalado']); ?>"  autocomplete="off" onKeyPress="return digitos(event, this);" />
                              <?php echo '<i style="color:red">' . form_error('peso_embalado') . '</i>'; ?>
                          </div>
                      </div>
                      <div class="row d-none">
                          <div class="form-group no-margin col-md-12 col-xs-12 <?php echo (form_error('qty_embalagem')) ? 'has-error' : '';  ?>">
                              <label for="qty_embalagem"><?= $this->lang->line('application_package_contains_more_product'); ?></label>
                          </div>
                          <div class="form-group col-md-2 col-xs-12 <?php echo (form_error('qty_embalagem')) ? 'has-error' : '';  ?>">
                              <input type="number" class="form-control" min="1" id="qty_embalagem" name="qty_embalagem" placeholder="<?= $this->lang->line('application_item_qty'); ?>" value="<?= set_value('qty_embalagem', $product_data['qty_embalagem']); ?>"  autocomplete="off" onKeyPress="return digitos(event, this);" />
                              <?php echo '<i style="color:red">' . form_error('qty_embalagem') . '</i>'; ?>
                          </div>
                      </div>
                  </div>-->
                            ...
                            <div class="box-footer">
                                ...
                                <?php if($product_data['id'] > 0) { ?>
                                    ...
                                    <div class="pull-right" >
                                        ...
                                        <a href="<?php echo base_url("products/log_products_view/$product_data[id]") ?>" class="btn btn-warning"><?= $this->lang->line('application_latest_changes'); ?></a>
                                    </div>
                                <?php } ?>
                            </div>
                            <!-- /.box-body -->
...
<script type="text/javascript">
    ...
    var delete_url = "<?php echo (!$storeCanUpdateProduct && $notAdmin) ? '' : base_url($product_data['is_on_bucket']?'Products/removeImageProduct':'/assets/plugins/fileinput/examples/delete.php'); ?>";
    ...
    $(document).ready(function() {
        ...
        $(add_line).click(function(e) { //on add input button click
           ...
           required = 'required';
            ...
            <?php if($side_active) { ?>
                linha = linha + '<div id="Ilvar" class="col-md-1"' + tag4 + '><input type="text" class="form-control" id="gr[]" name="gr[]" autocomplete="off"  placeholder="<?= $this->lang->line('application_side'); ?>"  /></div>';
            <?php } ?>
    ...
    function changeCategory(id) {
        ...
        $.ajax({
            ...
            data: "idcat=" + id,
            success: function(data) {
                var cats = '<div id="catlinkbuttondiv" class="form-group col-md-12 col-xs-12"><button type="button" onClick="toggleCatMktPlace(event)" <?= (in_array('disabledCategoryPermission', $this->permission) == true) ? 'disabled readonly' : '' ?>> Categorias por Marketplace</button>';
