    ...
    <div class="row">
        <div class="col-md-3 col-xs-12">
            <div class="box box-alert alert alert-warning ">
                <div class="box-body">
                    <?= $this->lang->line('application_import_rules_catalog_product') ?>
                </div>
            </div>
        </div>
        ...
        <div class="box box">
            <div class="box-body">
                <div class="col-md-3 col-xs-12">
                    <?= $this->lang->line('application_import_catalog_product_step_1') ?>
                    <hr>
                    <?php foreach ($catalogs as $catalog): ?>
                        <!-- metodo antigo Export/ProductCatalog/catalogId -->
                        <a href="<?=base_url("Export/ProductCatalogExport/$catalog[id]") ?>"><i class="fa fa-download"></i>  <?=sprintf($this->lang->line('application_download_catalog_products'), $catalog['name'])?></a><br><br>
                    <?php endforeach ?>
                </div>
                <div class="col-md-3 col-xs-12">
                    <?= $this->lang->line('application_import_catalog_product_step_2') ?>
                    <hr>
                    <a download="sample_catalog_products_marketplace.csv" href="<?=base_url('assets/files/sample_catalog_products_marketplace.csv') ?>"><i class="fa fa-download"></i>  <?=$this->lang->line('application_sample_catalog_product');?></a><br><br>
                    <a href="<?=base_url("Export/ProductCatalogExportByStore") ?>"><i class="fa fa-download"></i>  <?=$this->lang->line('application_userstore_catalog');?></a><br><br>
                </div>
                <?php if(!isset($validate_finish)): ?>
                    <div class="col-md-6 col-xs-12">
                        <?= $this->lang->line('application_import_product_step_3') ?>
                        <hr>
                        <form role="form" action="<?php echo base_url('ProductsLoadByCSV/onlyVerifyCatalogProduct') ?>" method="post" enctype="multipart/form-data" id="upload-file">
