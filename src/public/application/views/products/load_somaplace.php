                    ...
                    <div class="row">
                                ...
                                <div class="collapse" id="collapseRules">
                                    ...
                                    <table class="table table-striped table-warning table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>EAN</td>
                                                <td>Obrigatório - Código EAN do produto do catálogo, para associação.</td>
                                            </tr>
                                            <tr>
                                                <td>Catalogo</td>
                                                <td>Obrigatório - Informar Código ou Descrição do Catálogo.</td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="col-md-12">
                            <div class="kv-avatar form-group col-md-8">
                                <form role="form" action="<?php base_url('products/loadCatalog') ?>" method="post" enctype="multipart/form-data" id="upload-file">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <a href="<?=base_url('export/examplechargeproduct') ?>" class="btn btn-primary col-md-12" style="white-space: normal;"><i class="fa fa-download"></i> <br> <?=$this->lang->line('application_sample_product_file')?> (<?=$this->lang->line('application_stock')?>)</a>
                                <label for="product_upload">&nbsp;</label>
                                <a href="<?=base_url('export/exampleChargeProductCreate') ?>" class="btn btn-primary col-md-12 mt-2" style="white-space: normal;"><i class="fa fa-download"></i> <br> <?=$this->lang->line('application_sample_product_file')?> (<?=$this->lang->line('application_create')?>)</a>
                                <label for="product_upload">&nbsp;</label>
                                <a href="<?=base_url('export/catalogsXls') ?>" class="btn btn-primary col-md-12 mt-2" style="white-space: normal;"><i class="fa fa-download"></i> <br> <?=$this->lang->line('application_catalogs')?></a>
                                <label for="product_upload">&nbsp;</label>
                                <a href="<?=base_url('ProductsLoadByCSV/CatalogProduct') ?>" class="btn btn-primary col-md-12 mt-2" style="white-space: normal;"><i class="fa fa-link"></i> <br> <?=$this->lang->line('application_product_catalog_by_marketplace')?></a>
                            </div>
                        </div>
                    </div>
                              ...
                              <table class="table table-validate">
                                  ...
                                  <tbody>
                                    ...
                                    foreach ($validate_finish as $row => $status):
                                        ...
                                        if(empty($status) && $tipo_importacao == 0 && $validate_finish_prd_ext[$row]) echo "<td><ul><li>".$this->lang->line('messages_import_already_exists_complet')."</li></ul></td>";
              ...
              <div class="box-footer">
                  <div class="row">
                      <div class="col-md-12 d-flex justify-content-between">
                          ...
                          <form role="form" action="<?php base_url('products/loadCatalog') ?>" method="post" enctype="multipart/form-data" class="col-md-3 no-padding" id="import-complets">
                          ...
                          <form role="form" action="<?php base_url('products/loadCatalog') ?>" method="post" enctype="multipart/form-data" class="col-md-4 no-padding" id="import-complets-download-errors">
                          ...
                          <?php elseif(!$existError && $tipo_importacao == 0): ?>
                              <form role="form" action="<?php base_url('products/loadCatalog') ?>" method="post" enctype="multipart/form-data" class="col-md-3 no-padding" id="imports-no-errors">
                          ...
                          <?php if ($tipo_importacao == 0): ?>
                              <a href="<?=base_url('products/loadCatalog')?>" class="btn btn-danger col-md-3"><i class="fas fa-power-off"></i> <?=$this->lang->line('application_cancel_import');?></a>
                          <?php else: ?>
                              <a href="<?=base_url('products/loadCatalog')?>" class="btn btn-success col-md-3"><i class="fas fa-power-off"></i> <?=$this->lang->line('application_finish');?></a>
                          <?php endif ?>
                      </div>
                  </div>
              </div>
