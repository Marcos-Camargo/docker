<div class="content-wrapper">
    <?php
    $data['pageinfo'] = "application_import_change_product_category_csv";
        ...
        <div class="row">
            <div class="col-md-3 col-xs-12">
                <div class="box box-alert alert alert-warning ">
                    <div class="box-body">
                        <?= $this->lang->line('application_import_rules_change_product_category') ?>
            ...
            <div class="col-md-9 col-xs-12">
                <div class="box box">
                    <div class="box-body">
                        <div class="col-md-3 col-xs-12">
                            <?= $this->lang->line('application_import_rules_change_product_category_step_1') ?>
                            <hr>
                            <a download="sample_change_product_category.csv" href="<?=base_url('assets/files/sample_change_product_category.csv') ?>"><i class="fa fa-download"></i>  <?=$this->lang->line('application_sample_change_product_category');?></a><br><br>
                        </div>
                        <div class="col-md-3 col-xs-12">
                            <?= $this->lang->line('application_import_rules_change_product_category_step_2') ?>
                            <hr>
                            <a href="<?=base_url('export/categoriesxls') ?>"><i class="fa fa-file-excel-o"></i> <?=$this->lang->line('application_categories_export')?></a>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <?= $this->lang->line('application_import_rules_change_product_category_step_3') ?>
                            <hr>
