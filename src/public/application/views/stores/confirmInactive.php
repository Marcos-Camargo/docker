            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?= $this->lang->line('messages_inactive_confirm_mensage_stores'); ?></h3>
                        <br><br>
                        ...
                        <h4><?=$additional_message?></h4>
                    </div>
                    <form role="form" action="<?= (base_url('company/update')) ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                        </div>
                        <div class="box-footer">
                            <a type="submit" href="<?php echo base_url('stores/inactiveConfirmed/') . $store_id ?>" class="btn btn-danger"><?= $this->lang->line('application_inactivate'); ?> </a>
