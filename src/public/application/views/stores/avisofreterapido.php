...
Mostra as lojas x e tipos de volumes do frete rápido novos para que seja alterada a configuração no Ferete rápido
...
<div class="content-wrapper">
	...
	<?php $data['pageinfo'] = "application_manage";  
	 $data['page_now'] ='stores_new_categories';
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
		...
		<div id="showActions">
          ...
          <a class="pull-right btn btn-primary" href="<?php echo base_url('export/LojaNovaCategoriaXls') ?>"><i class="fa fa-file-excel-o"></i> <?=$this->lang->line('application_data_export')?></a>
          <br />
          <br />
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
		  <form role="form" action="<?php echo base_url('stores/avisoFreteRapidoSelect') ?>" method="post" id="selectForm">
            ...
            <table id="manageTable" class="table table-bordered table-striped">
	          ...
	          <!---  <th><input type="checkbox" name="select_all" value="1" id="manageTable-select-all"></th>        -->   
                ...
                <th><?=$this->lang->line('application_categories_frete_rapido');?></th> 
            ...
            <div class="col-md-12">
	          ...
	          <div class="col-md-3">  
				<!---  <button type="submit" class="btn btn-primary" id="select" name="select"><?=$this->lang->line('application_mark_store_as_reconfigured');?></button> -->
	          </div>	
	          <!----
	          <div class="col-md-3">  
...
$(document).ready(function() {
    ...
    $("#avisoFreteRapidoNav").addClass('active');
   ...
   //        'render': function (data, type, full, meta){
    ...
    //    }],
        "ajax": $.fn.dataTable.pipeline( {
            url: base_url + 'stores/avisoFreteRapidoData',
            data: { }, 
