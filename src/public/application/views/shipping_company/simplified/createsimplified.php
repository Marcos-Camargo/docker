...
Criar transportadoras simplificado

-->
  <!-- Content Wrapper. Contains page content -->
<div class="content-wrapper">
	<?php $data['pageinfo'] = "application_add";  $data['page_now'] = 'add_new_seller_shipping_company';  $this->load->view('templates/content_header',$data) ?>
    <section class="content">
        <div class="row">
            ...
            <?php endif?>
            <form role="form" action="<?php base_url('shippingcompany/createsimplified') ?>" method="post" id="createShippingCompany">
                        ...
                        <div class="tab-pane" id="config_shipping_company">
                            <div class="row">
                                <div class="form-group col-md-4 <?=count($stores) === 1 ? 'd-none' : ''?>">
                                    ...
                                    <select class="form-control select2" name="store" id="store" required >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" id="slc_tipo_cubage" name="slc_tipo_cubage" <?=set_value('slc_tipo_cubage')?> required>
                                        <option value="FreteCubadoNao">Não</option>
                                        <option value="FreteCubadoSim">Sim</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-3" id="divFretecubado">
...
$('#createShippingCompany button[type="submit"]').on('click', function () {
  ...
  if (el.find('[name="cnpj"]').val() === '') {
      ...
      if (!isCNPJValid(el.find('[name="cnpj"]').val())) {
          errors.push(el.find('[name="cnpj"]').closest('.form-group').find('label').text().remove_asterisk());
      }
  }
