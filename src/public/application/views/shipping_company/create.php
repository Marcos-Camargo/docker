      ...
      <div class="row">
        <div class="col-md-12 col-xs-12" id="rowcol12">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('providers/create') ?>" method="post">
				...
				<div id="divTransportadora">
    				...
    				<div class="row">
    	                ...
    	                <div class="form-group col-md-2">
        	                  ...
        	                  <input type="text" class="form-control" id="txt_regiao_entrega" name="txt_regiao_entrega" placeholder="<?=$this->lang->line('application_providers_region_delivery')?>" autocomplete="off" value="<?=set_value('regiao_entrega')?>">
        	             </div> 
        	             
        	             <div class="form-group col-md-2">
        	                  <label for="account"><?=$this->lang->line('application_providers_region_collect');?>(*)</label>
        	                  <input type="text" class="form-control" id="txt_regiao_coleta" name="txt_regiao_coleta" placeholder="<?=$this->lang->line('application_providers_region_collect')?>" autocomplete="off" value="<?=set_value('regiao_coleta')?>">
        	             </div> 
        	             
        	             <div class="form-group col-md-3">
        	                  <label for="account"><?=$this->lang->line('application_providers_time_collect');?></label>
        	                  <input type="text" class="form-control" id="txt_tempo_coleta" name="txt_tempo_coleta" placeholder="<?=$this->lang->line('application_providers_time_collect')?>" autocomplete="off" value="<?=set_value('tempo_coleta')?>">
        	             </div> 
        	             
        	             <div class="form-group col-md-3">
        	                  <label for="account"><?=$this->lang->line('application_providers_finan_flow');?>(*)</label>
        	                  <input type="text" class="form-control" id="txt_fluxo_fin" name="txt_fluxo_fin" placeholder="<?=$this->lang->line('application_providers_finan_flow')?>" autocomplete="off" value="<?=set_value('fluxo_fin')?>">
        	             </div> 
        	        </div>
