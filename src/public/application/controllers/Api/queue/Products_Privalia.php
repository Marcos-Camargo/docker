<?php
/*
* recebe a requisição e cadastra / alterara /inativa na Privalia
 */
require APPPATH . "controllers/Api/queue/ProductsVtexV2.php";

class Products_Privalia extends ProductsVtexV2{
        public function __construct() {
        parent::__construct();

        $this->int_to = 'Privalia';
        $this->tradesPolicies = array('1');
        $this->adlink = 'http://www.privalia.com.br';
