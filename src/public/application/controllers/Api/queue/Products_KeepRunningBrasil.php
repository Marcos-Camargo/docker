<?php 
/* 
* recebe a reuisição e cadastra / alterara /inativa na KeepRunningBrasil
 */
require APPPATH . "controllers/Api/queue/ProductsVtexV2.php";
     
class Products_KeepRunningBrasil extends ProductsVtexV2{
	
	
    public function __construct() {
        parent::__construct();
	   
		$this->int_to = 'KeepRunningBrasil';
		$this->tradesPolicies = array('1');
		$this->adlink = 'https://www.keeprunningbrasil.com.br/';
