<?php 
/* 
* recebe a reuisição e cadastra / altera /inativa no Polishop / ForeverLiss
 */
require APPPATH . "controllers/Api/queue/ProductsVtexV2.php";
     
class Products_Shopdoscabelos extends ProductsVtexV2{
	
	
    public function __construct() {
        parent::__construct();
	   
		$this->int_to = 'Shopdoscabelos';
		$this->tradesPolicies = array('1');
		$this->adlink = 'shopdoscabelos.conectala.com.br';
