...
class ExportPivotsb2wUltEnvio extends BatchBackground_Controller
{   
    ...
    private function processExport()
    {
        ...
        while ($proceed) {
            ...
            $dir = getcwd() . "/$dir";
            if (is_dir($dir)) {
                file_put_contents("$dir/ms_shipping_pivots_b2w_ult_envio" . date("Ymd_His") . "_$offset-$iteration.sql", $insert);
            }
        }
    }
}
