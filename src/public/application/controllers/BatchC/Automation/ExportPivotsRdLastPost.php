...
class ExportPivotsRdLastPost extends BatchBackground_Controller
{   
    ...
    private function processExport()
    {
        ...
        while ($proceed) {
            ...
            foreach ($results as $result) {
                ...
                $insert .= "('$marketplace', $company_id, $store_id, '$seller_id', '$cnpj', '$zip_code', '$ean', '$sku_seller', '$sku_mkt', '$sku_local', $product_id, $product_variant, $price, $list_price, $category_id, $quantity, $quantity_total, $height, $width, $length, $gross_weight, $quantity_per_package, $crossdocking, '$created_at', '$updated_at')";
            }
            $insert .= ";";
            ...
            $dir = getcwd() . "/$dir";
            if (is_dir($dir)) {
                file_put_contents("$dir/ms_shipping_pivots_rd_last_post" . date("Ymd_His") . "_$offset-$iteration.sql", $insert);
            }
        }
    }
}
