...
Realiza a integração com SellerCenter Conectala
...
{     
    ...
    function deliveredOrder($api_keys, $order, $items, $nfe, $freight)
    {
        ...
        $url = $this->url_api . "Orders/". $order["bill_no"] ."/delivered";
        $response = $this->postRequest($url, $api_keys, $this->castSentOrder($order, $items, $nfe, $freight));
        return $response;
    }
	...
	function orderTracking($api_keys,$order,  $tracking)
    {
        $url = $this->url_api . "Tracking/". $order["bill_no"]; 
        $response = $this->postRequest($url, $api_keys, $tracking);
        return $response;
    }
    ...
    function deliveredOrderNew($api_keys, $order, $data)
    {
        $url = $this->url_api . "Orders/". $order["bill_no"] ."/delivered";
        $response = $this->putRequest($url, $api_keys, $data);
        return $response;
    ...
    function getOrdersCanceled($api_keys)
    {
        ...
        $url = $this->url_api.'Orders?status=95,96,97&start_date='.$initialDate;
        $url = $this->url_api.'Orders?status=95,96,97';
        $response = $this->getRequest($url, $api_keys);
        return $response;
    }
