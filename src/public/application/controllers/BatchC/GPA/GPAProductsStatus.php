 ...
 * 
*/   
require APPPATH . "controllers/BatchC/Marketplace/Mirakl/ProductsStatus.php";
 class GPAProductsStatus extends ProductsStatus {
	...
	// php index.php BatchC/GPA/GPAProductsStatus run null
