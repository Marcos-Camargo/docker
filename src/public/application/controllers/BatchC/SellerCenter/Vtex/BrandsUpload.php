...
class BrandsUpload extends Main
{
  ...
  public function __construct()
	...
	// php index.php BatchC/SellerCenter/Vtex/BrandsUpload run null CasaeVideo
    ...
    private function createBrandInBrandMkt($integration): void
    {
