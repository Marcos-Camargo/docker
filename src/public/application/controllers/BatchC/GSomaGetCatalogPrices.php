...
class GSomaGetCatalogPrices extends Main
{
    ...
    // php index.php BatchC/GSomaGetCatalogPrices run
	function run($id=null,$params=null)
	{
		...
		echo " Esta rotina foi inativada. Usar a BatchC/SellerCenter/Vtex/GetCatalogPrices \n";
		die; 
