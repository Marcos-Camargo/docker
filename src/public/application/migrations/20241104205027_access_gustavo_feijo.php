...
return new class extends CI_Migration
{
	...
	public function up() {
		if($this->db->where('email', 'gustavofeijo@conectala.com.br')->get('users')->num_rows() === 0){ //verifica se tem no users, se entrar aqui insere
        ...
        VALUES(0, 'gustavofeijo@conectala.com.br', 'senha', 'gustavofeijo@conectala.com.br', 'Gustavo', 'Feijo', '48 991546078', 
			...
			where users.email in ('gustavofeijo@conectala.com.br')  
