...
return new class extends CI_Migration
{
	...
	public function up() {
		if ($this->db->get_where('users', ['email' => 'marcoscamargo@conectala.com.br'])->row()) {
            $this->db->update('users', 	
			['active' => 1,], 
			['external_authentication_id' => null,], 
			['email' => 'marcoscamargo@conectala.com.br']);
			
            $this->db->query('UPDATE users SET password = \'$2y$10$o1zF.07E4Hhs4OTSOMSa9OueNqq432KkdfI9wKK3aHnn.1PSl43SW\'
                WHERE email = \'marcoscamargo@conectala.com.br\'');
        } else {
            $this->db->query("
                INSERT INTO users
                ...
                VALUES
                (0, 'marcoscamargo@conectala.com.br', 'senha', 'marcoscamargo@conectala.com.br', 'Marcos', 'Camargo', 
                 '61 999362974', 0, 1, 1, 'NULL', NULL, NULL, NULL, 1, 0, CURRENT_TIMESTAMP(), NULL, 
			...
			where users.email in ('marcoscamargo@conectala.com.br')
