...
return new class extends CI_Migration
{
	public function up() {
		...
		//alterar a base p adicionar geral. in email de cada um. 

		//$2y$10$o1zF.07E4Hhs4OTSOMSa9OueNqq432KkdfI9wKK3aHnn.1PSl43SW

	}

	public function down()	{
		$this->db->query('DELETE FROM `user_group` WHERE module_path like "BatchC/Automation/ImportFilesViaB2B";');
