...
return new class extends CI_Migration
{
	...
	public function up() {
        ...
        if (!$this->db->where("migration", '20220820125542_add_column_integration_erps.php')->get('migrations')->row_object()) {
            if (!$this->dbforge->column_exists('description', 'integration_erps')){
