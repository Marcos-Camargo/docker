...
return new class extends CI_Migration
{
	...
	public function up() {
        ...
        $this->db->query("
            ...
            select 'Script/FixCatalogProductTrashSkuIntegration', 'run', alfi.store_id, 0, 0, NULL, 0, NULL, DATE_ADD(NOW(), INTERVAL 10 MINUTE), NULL, 0, null, NULL, NULL from anymarket_log_fix_id alfi
